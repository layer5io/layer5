...
export const cssTheme = {
  black: "var(--black)",
  white: "var(--white)",
  offWhiteColor: "var(--offWhiteColor)",
  navigatorColor: "var(--navigatorColor)",
  body: "var(--body)",
  textRevert: "var(--textRevert)",
  text: "var(--text)",
  bodyRevert: "var(--bodyRevert)",
  toggleBorder: "var(--toggleBorder)",
  backgroundColor: "var(--backgroundColor)",
  primaryColor: "var(--primaryColor)",
  primaryLightColor: "var(--primaryLightColor)",
  primaryLightColorTwo: "var(--primaryLightColorTwo)",
  keppelColor: "var(--keppelColor)",
  secondaryColor: "var(--secondaryColor)",
  caribbeanGreenColor: "var(--caribbeanGreenColor)",
  secondaryLightColorTwo: "var(--secondaryLightColorTwo)",
  secondaryLightColor: "var(--secondaryLightColor)",
  tertiaryColor: "var(--tertiaryColor)",
  darkJungleGreenColor: "var(--darkJungleGreenColor)",
  darkJungleGreenHalfColor: "var(--darkJungleGreenHalfColor)",
  tertiaryColorTwo: "var(--tertiaryColorTwo)",
  headingColor: "var(--headingColor)",
  textColor: "var(--textColor)",
  shadowColor: "var(--shadowColor)",
  shadowLightColor: "var(--shadowLightColor)",
  menuColor: "var(--menuColor)",
  menuHoverColor: "var(--menuHoverColor)",
  linkColor: "var(--linkColor)",
  highlightColor: "var(--highlightColor)",
  saffronColor: "var(--saffronColor)",
  highlightLightColor: "var(--highlightLightColor)",
  saffronLightColor: "var(--saffronLightColor)",
  projectPageShadowsize: "var(--projectPageShadowsize)",
  projectShadowsize: "var(--projectShadowsize)",
  siteLinkBrightness: "var(--siteLinkBrightness)",
  invertColor: "var(--invertColor)",
  meshInterfaceLogoFilter: "var(--meshInterfaceLogoFilter)",
  mapBackground: "var(--mapBackground)",
  elevationColor: "var(--elevationColor)",
  selectionColor: "var(--selectionColor)",
  activeColor: "var(--activeColor)",
  blackFiveToWhiteFive: "var(--blackFiveToWhiteFive)",
  blackFourToWhiteFour: "var(--blackFourToWhiteFour)",
  blackOneToBlackZeroFive: "var(--blackOneToBlackZeroFive)",
  blackToGreen3C494F: "var(--blackToGreen3C494F)",
  blackToWhite: "var(--blackToWhite)",
  blue477E96ToGreen00B39F: "var(--blue477E96ToGreen00B39F)",
  blueE0FFFCToBlue477E96: "var(--blueE0FFFCToBlue477E96)",
  boxShadowBlue477E96: "var(--boxShadowBlue477E96)",
  boxShadowGreen00D3A9: "var(--boxShadowGreen00D3A9)",
  boxShadowGreen00D3A9ToBlackTwoFive:
  "var(--boxShadowGreen00D3A9ToBlackTwoFive)",
  boxShadowGreyA3A3A3toBlackTwo:
  "var(--boxShadowGreyA3A3A3toBlackTwo)",
  boxShadowGreyBABABAtoBlackTwoFive:
  "var(--boxShadowGreyBABABAtoBlackTwoFive)",
  green009A89ToGreen00B39F: "var(--green009A89ToGreen00B39F)",
  green00B39FToBlackFive: "var(--green00B39FToBlackFive)",
  green00B39FToBlackFour: "var(--green00B39FToBlackFour)",
  green00B39FToGreen3C494F: "var(--green00B39FToGreen3C494F)",
  green00B39FToGreyB3B3B3: "var(--green00B39FToGreyB3B3B3)",
  green00D3A9ToBlackFour: "var(--green00D3A9ToBlackFour)",
  green00D3A9ToBlackTwo: "var(--green00D3A9ToBlackTwo)",
  green00D3A9ToBlue477E96: "var(--green00D3A9ToBlue477E96)",
  green00D3A9ToGreen00B39F: "var(--green00D3A9ToGreen00B39F)",
  green00D3A9ToGreen00B39FFive: "var(--green00D3A9ToGreen00B39FFive)",
  green00D3A9ToGreen3C494F: "var(--green00D3A9ToGreen3C494F)",
  green00D3A9ToGreyE6E6E6: "var(--green00D3A9ToGreyE6E6E6)",
  green3C494FToGreyF5F5F5: "var(--green3C494FToGreyF5F5F5)",
  grey050505ToGreyF1F2F1: "var(--grey050505ToGreyF1F2F1)",
  grey0E0E0EToGreen3C494F: "var(--grey0E0E0EToGreen3C494F)",
  grey101010ToGreyF7F7F7: "var(--grey101010ToGreyF7F7F7)",
  grey111111ToGreyFAFAFA: "var(--grey111111ToGreyFAFAFA)",
  grey121212EightToWhiteEight: "var(--grey121212EightToWhiteEight)",
  grey121212ToGreyEFEFEF: "var(--grey121212ToGreyEFEFEF)",
  grey121212ToLinear: "var(--grey121212ToLinear)",
  grey121212ToWhite: "var(--grey121212ToWhite)",
  grey141414ToGreyF5F5F5: "var(--grey141414ToGreyF5F5F5)",
  grey141414ToGreyFAFAFA: "var(--grey141414ToGreyFAFAFA)",
  grey141714ToGreenEBFCF8: "var(--grey141714ToGreenEBFCF8)",
  grey151515OneToWhiteOne: "var(--grey151515OneToWhiteOne)",
  grey191919ToGreyFAFAFA: "var(--grey191919ToGreyFAFAFA)",
  grey1D1817ToGreyE6E6E6: "var(--grey1D1817ToGreyE6E6E6)",
  grey1D1D1DToGreyFAFAFA: "var(--grey1D1D1DToGreyFAFAFA)",
  grey1D1D1DToLinear2: "var(--grey1D1D1DToLinear2)",
  grey212121ToBlack: "var(--grey212121ToBlack)",
  grey212121ToGreen1E2117: "var(--grey212121ToGreen1E2117)",
  grey212121ToGreen3C494F: "var(--grey212121ToGreen3C494F)",
  grey212121ToGreyEEEEEE: "var(--grey212121ToGreyEEEEEE)",
  grey212121ToGreyEFEFEF: "var(--grey212121ToGreyEFEFEF)",
  grey212121ToGreyF0F0F0: "var(--grey212121ToGreyF0F0F0)",
  grey212121ToGreyF3F3F3: "var(--grey212121ToGreyF3F3F3)",
  grey212121ToGreyF5F5F5: "var(--grey212121ToGreyF5F5F5)",
  grey212121ToLinear: "var(--grey212121ToLinear)",
  grey212121ToLinear2: "var(--grey212121ToLinear2)",
  grey212121ToWhite: "var(--grey212121ToWhite)",
  grey222222ToGreen1E2117: "var(--grey222222ToGreen1E2117)",
  grey222222ToWhite: "var(--grey222222ToWhite)",
  grey232323ToGreyEEEEEE: "var(--grey232323ToGreyEEEEEE)",
  grey262626ToGreen3C494F: "var(--grey262626ToGreen3C494F)",
  grey313131ToGreenC9FCF6: "var(--grey313131ToGreenC9FCF6)",
  grey313131ToYellowFFF7D8: "var(--grey313131ToYellowFFF7D8)",
  grey323232ToGreenF3FFFD: "var(--grey323232ToGreenF3FFFD)",
  grey3C3C3CToGreyF1F1F1: "var(--grey3C3C3CToGreyF1F1F1)",
  grey404040ToGreen3C494F: "var(--grey404040ToGreen3C494F)",
  grey404040ToGrey1E2117: "var(--grey404040ToGrey1E2117)",
  grey737373ToGrey222222: "var(--grey737373ToGrey222222)",
  grey737373ToGrey4C4A4A: "var(--grey737373ToGrey4C4A4A)",
  grey737373ToGreyB3B3B3: "var(--grey737373ToGreyB3B3B3)",
  grey8C8C8CToGreen1E2117: "var(--grey8C8C8CToGreen1E2117)",
  grey8C8C8CToGreyA0A0A0: "var(--grey8C8C8CToGreyA0A0A0)",
  grey939393ToGrey4C4A4A: "var(--grey939393ToGrey4C4A4A)",
  greyA0AAAAToGrey666666: "var(--greyA0AAAAToGrey666666)",
  greyAAAAAAToGrey7A848E: "var(--greyAAAAAAToGrey7A848E)",
  greyB1B6B8ToBlue477E96: "var(--greyB1B6B8ToBlue477E96)",
  greyB4B4B4ToGrey505050: "var(--greyB4B4B4ToGrey505050)",
  grey505050ToGreyB4B4B4: "var(--grey505050ToGreyB4B4B4)",
  greyC1C1C1ToGreyB3B3B3: "var(--greyC1C1C1ToGreyB3B3B3)",
  greyC8C8C8ToGreen3C494F: "var(--greyC8C8C8ToGreen3C494F)",
  greyD3D7DBToGreen1E2117: "var(--greyD3D7DBToGreen1E2117)",
  greyDCDCDCToGrey3B3B3B: "var(--greyDCDCDCToGrey3B3B3B)",
  greyDDDDDDToGrey333333: "var(--greyDDDDDDToGrey333333)",
  greyDEE3DEToGreen3C494F: "var(--greyDEE3DEToGreen3C494F)",
  greyDEE3DEToGrey363636: "var(--greyDEE3DEToGrey363636)",
  greyEEEEEEToBlack: "var(--greyEEEEEEToBlack)",
  greyFiveToBlueFive: "var(--greyFiveToBlueFive)",
  linearToLinear: "var(--linearToLinear)",
  linearToLinear2: "var(--linearToLinear2)",
  linearToWhite: "var(--linearToWhite)",
  whiteEightToBlack: "var(--whiteEightToBlack)",
  whiteEightToBlackEight: "var(--whiteEightToBlackEight)",
  whiteFiveToBlackFive: "var(--whiteFiveToBlackFive)",
  whiteFourToBlackFour: "var(--whiteFourToBlackFour)",
  whiteFourToGreyCECECE: "var(--whiteFourToGreyCECECE)",
  whiteNineToBlackOne: "var(--whiteNineToBlackOne)",
  whiteOneFiveToBlackOneFive: "var(--whiteOneFiveToBlackOneFive)",
  whiteOneToBlackOne: "var(--whiteOneToBlackOne)",
  whiteOneToGreyCECECE: "var(--whiteOneToGreyCECECE)",
  whiteOneToGreyF0F0F0: "var(--whiteOneToGreyF0F0F0)",
  whiteSevenFiveToBlackSevenFive:
  "var(--whiteSevenFiveToBlackSevenFive)",
  whiteSevenToBlackSeven: "var(--whiteSevenToBlackSeven)",
  whiteSixFiveToBlackSixFive: "var(--whiteSixFiveToBlackSixFive)",
  whiteSixToBlackSix: "var(--whiteSixToBlackSix)",
  whiteSixToGreen3C494F: "var(--whiteSixToGreen3C494F)",
  whiteToBlack: "var(--whiteToBlack)",
  whiteToGreen00D3A9: "var(--whiteToGreen00D3A9)",
  whiteToGreen1E2117: "var(--whiteToGreen1E2117)",
  whiteToGreen3C494F: "var(--whiteToGreen3C494F)",
  whiteToGrey4C4A4A: "var(--whiteToGrey4C4A4A)",
  whiteToGrey737373: "var(--whiteToGrey737373)",
  whiteToGreyB3B3B3: "var(--whiteToGreyB3B3B3)",
  whiteToGreyE6E6E6: "var(--whiteToGreyE6E6E6)",
  whiteZeroEightToBlackZeroEight:
  "var(--whiteZeroEightToBlackZeroEight)",
  whiteZeroFiveToBlackZeroFive: "var(--whiteZeroFiveToBlackZeroFive)",
  whiteZeroThreeToBlackZeroOne: "var(--whiteZeroThreeToBlackZeroOne)",
  whiteZeroThreeToBlackZeroThree:
  "var(--whiteZeroThreeToBlackZeroThree)",
  whiteToBlue1229A9: "var(--whiteToBlue1229A9)",
  whiteToBlue2A2DDE: "var(--whiteToBlue2A2DDE)",
};
