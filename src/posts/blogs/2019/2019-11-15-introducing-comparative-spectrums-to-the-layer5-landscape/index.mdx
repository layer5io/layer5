...
author: Rafi Ungar
thumbnail: ../../../../images/layer5/layer5-community-linkedin-center.png
...
<img className="card-left a" src={card1} alt="Card"/>

_or this:_

<img className="card-right" src={card2} alt="Card"/>
...
_- [Rafi Ungar](https://meshery.io/contributors/rafi-ungar/)
