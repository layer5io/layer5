...
const data = {
  faqs: [
    ...
    {
      question: "Will my learning progress be saved if I leave and come back later?",
      category: "Academy",
      answer: [
    ...
    {
      question: "Can I skip courses and jump directly to the exam?",
      category: "Academy",
      answer: [
    ...
    {
      question: "If I fail an assessment, can I retake it?",
      category: "Academy",
      answer: [
    ...
    {
      question: "Is Layer5 Academy free to use?",
      category: "Academy",
      answer: [
    ...
    {
      question: "Can I download content materials for offline study?",
      category: "Academy",
      answer: [
    ...
    {
      question: "Where can I ask questions or discuss the content material?",
      category: "Academy",
      answer: [
        "Learning is often better together. If you have questions about the content or want to discuss topics with other learners and instructors, we encourage you to join the Layer5 Community."
      ],
      link: "https://layer5.io/community/handbook",
      linktext: "Layer5 Community Handbook",
    }
