...
thumbnail: ./The-Enterprise-Path-to-Service-Mesh-Architectures.png
author: "Lee Calcote"
...
import service_mesh_book from "./The-Enterprise-Path-to-Service-Mesh-Architectures-small.png"
import Button from "../../../reusecore/Button";


<BookWrapper>

<div className="book"><a href={service_mesh_book}><img className="card" width="300px" src={service_mesh_book} alt="The-Enterprise-Path-to-Service-Mesh-Architectures-small" align="centre" /></a><div>&nbsp;</div>
  <div className="two-buttons">
        <Button className="pa-8 mr-2" title="Get free ebook" url="https://www.nginx.com/resources/library/the-enterprise-path-to-service-mesh-architectures?utm_source=calcote" external="true" />
        <Button className="pa-8 mr-2" title="Read on Safari" url="https://www.nginx.com/resources/library/the-enterprise-path-to-service-mesh-architectures?utm_source=calcote" external="true" />
  </div>
</div>
