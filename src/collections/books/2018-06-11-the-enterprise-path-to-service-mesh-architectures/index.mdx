...
<h2>Book: <i>The Enterprise Path to Service Mesh Architectures</i></h2><br/>

<div className="book"><a href={service_mesh_book}><img className="card" width="300px" src={service_mesh_book} align="right" /></a><div>&nbsp;</div>
  <a href="https://www.nginx.com/resources/library/the-enterprise-path-to-service-mesh-architectures?utm_source=calcote" >
    <Button className="banner-btn one pa-8 mr-2">
        Get free ebook
    </Button>
  </a>
  <a href="https://www.nginx.com/resources/library/the-enterprise-path-to-service-mesh-architectures?utm_source=calcote">
