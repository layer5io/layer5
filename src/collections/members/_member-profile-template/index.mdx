...
permalink: # (Optional and should only be used in case of url conflict) Custom URL path for this member, e.g. yash-sharma-2. It will be used as /community/members/<permalink> if present. see https://github.com/layer5io/layer5/issues/6381
---
