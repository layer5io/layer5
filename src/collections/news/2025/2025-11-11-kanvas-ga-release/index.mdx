...
"The rise of AI is about to amplify that complexity tenfold as it brings an onslaught of suggested infrastructure changes from non-deterministic LLMs, whose inherent risk of hallucination only exacerbates the cognitive overload of engineers”, says Lee Calcote, CEO of Layer5.
...
“Teams simply cannot be expected to approve a black box of LLM-generated changes. The way to safely harness the power of AI is to combat cognitive load ‘head-on’, says Calcote. “This means visually representing *all* changes—whether from a human or an AI—in a way the mind can readily digest. A picture is worth a thousand words, as they say. In Kanvas, we call this 'infrastructure as design.'”
