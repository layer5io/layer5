...
import service-mesh-abstractions from "./service-mesh-abstractions.png";
import service-mesh-performance from "./service-mesh-performance.png";
...
<a href={service-mesh-abstractions}><img scr={service-mesh-abstractions} alt="service-mesh-abstractions" width="100%" /></a>
...
<a href={service-mesh-performance}><img scr={service-mesh-performance} alt="service-mesh-performance" width="100%" /></a>
