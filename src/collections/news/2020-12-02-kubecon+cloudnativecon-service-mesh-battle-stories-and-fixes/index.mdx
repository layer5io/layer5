...
<a href={serviceMeshAbstractions}><img scr={serviceMeshAbstractions} alt="service-mesh-abstractions" width="100%" /></a>
...
<a href={serviceMeshPerformance}><img scr={serviceMeshPerformance} alt="service-mesh-performance" width="100%" /></a>
