...
<ol>
    <li> Performance Management - for workloads on and off of service meshes and inside and outside of Kubernetes clusters. .</li>
    <li> Configuration Management - with deployment of established usage patterns and analysis against configuration best practices; integration of Open Application Model. </li>
    <li> Lifecycle Management - for service mesh provisioning and workload onboarding. 4. Intelligence Management - for dynamic configuration and deployment of WebAssembly filters for Envoy 5. Interoperation and federation - by managing multiple service meshes concurrently.</li>
</ol>
