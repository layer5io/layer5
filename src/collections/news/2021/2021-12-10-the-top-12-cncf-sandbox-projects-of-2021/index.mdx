...
<h3>8. Meshery</h3>
<Link to="/cloud-native-management/meshery">Meshery</Link> was created by <Link to ="/company/about">Layer5</Link> and joined the ranks of the CNCF in October 2021 as a service mesh management plane.
A service mesh is the infrastructure layer deployed on a Kubernetes cluster that lets you manage communication among an application’s microservices.
Meshery gives you a plane to set up, deploy, and benchmark several service mesh solutions available on the market.
With Meshery, you can apply custom configurations based on industry best practices to your service mesh and monitor its performance.
