...
<a href="https://smp-spec.io">Service Mesh Performance</a> is a vendor neutral, cloud native
...
<ul>
  <li>
    <a href="https://smp-spec.io/subscribe">Community Newsletter</a>
  </li>
  <li>
    <a href="https://discuss.layer5.io">Service Mesh Discussion Forum</a>
  </li>
  <li>
    <a href="https://twitter.com/smp_spec">Service Mesh Performance Twitter</a>
  </li>
  <li>
    <a href="https://www.linkedin.com/showcase/service-mesh-performance">
      Service Mesh Performance LinkedIn
    </a>
  </li>
  <li>
    <a href="https://www.youtube.com/watch?v=_yrncjtPpg4&list=PL3A-A6hPO2INwi8A3NNClvdCxDoHa9NOU">
      Service Mesh Performance YouTube
    </a>
  </li>
  <li>
    <a href="https://smp-spec.io">Service Mesh Performance Website</a>
  </li>
</ul>
