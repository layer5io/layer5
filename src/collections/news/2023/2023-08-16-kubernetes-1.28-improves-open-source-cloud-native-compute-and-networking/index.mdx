...
<Link to="/community/members/lee-calcote/bio">Lee Calcote</Link>, founder of <Link to="/about">
  Layer5
</Link> and a CNCF contributor, explained that one of the key networking updates is an enhancement
