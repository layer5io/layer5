...
“Kubernetes has yet to address this deeper area of network traffic management, which is where CNCF projects like <Link to="/cloud-native-management/meshery">Meshery</Link> step in with WASM filter management for any Envoy proxy or Envoy-based service-mesh data plane,” he said.
