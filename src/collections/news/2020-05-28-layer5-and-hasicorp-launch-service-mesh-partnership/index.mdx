...
import image1 from "./layer5-HashiCorp-Service-Mesh-Partnership.png";

import image2 from "./layer5-image-hub-on-hashicorp-consul.png";
...
<a href={Image1}><img scr={Image1} width="100%" /></a>
...
<a href={Image2}><img src={Image2} width="100%" /></a>
