...
<a href={serviceMeshAbstractions}>
  <img src={serviceMeshAbstractions} alt="service-mesh-abstractions" width="100%" />
</a>
...
<a href={serviceMeshPerformance}>
  <img src={serviceMeshPerformance} alt="service-mesh-performance" width="100%" />
</a>
