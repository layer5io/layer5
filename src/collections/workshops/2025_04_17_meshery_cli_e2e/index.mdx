...
<strong>Trainer:</strong> <a href="https://layer5.io/community/members/riya-garg" target="_blank">Riya Garg</a> <br />
<strong>Technologies:</strong> BATS, Shell, Meshery CLI
...
<br />
<h4 style={{ marginBottom: "1.25rem" }}><a href="https://docs.google.com/presentation/d/1OhUhqIZVPdnjD7eO1ppeXVvTa-P2lIcdCXHncTOX_XE/edit?usp=sharing" target="_blank">Workshop Slides</a></h4>
<br />
<h4 style={{ marginBottom: "1.25rem" }}><a href="https://docs.meshery.io/project/contributing/contributing-cli-tests" target="_blank">Contributing CLI Tests Guide</a></h4>
<br />
<h4 style={{ marginBottom: "1.25rem" }}>Workshop Recording</h4>

<iframe width="50%" src="https://www.youtube.com/embed/mRQAvR9-P1o" loading="lazy" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" style={{ minHeight: "315px", minWidth: "280px", margin: "auto", textAlign: "center" }} allowFullScreen></iframe>
<br />
<br />
