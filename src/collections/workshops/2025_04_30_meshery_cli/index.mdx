...
<br />
<h4 style={{ marginBottom: "1.25rem" }}><a href="https://docs.google.com/presentation/d/1lRop7DAAMUBmuFdzZK25LdQrkLG08eVsXEaDrauP3S8/edit?slide=id.p1#slide=id.p1" target="_blank">Workshop Slides</a></h4>
<br />
<h4 style={{ marginBottom: "1.25rem" }}><a href="https://docs.meshery.io/project/contributing/contributing-cli" target="_blank">CLI Contribution Guide</a></h4>
<br />
<h4 style={{ marginBottom: "1.25rem" }}>Workshop Recording</h4>

<iframe width="50%" src="https://www.youtube.com/embed/ijunTqSqSbg" loading="lazy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" style={{ minHeight: "315px", minWidth: "280px", margin: auto, textAlign: "center" }} allowfullscreen></iframe>
<br />
<br />
