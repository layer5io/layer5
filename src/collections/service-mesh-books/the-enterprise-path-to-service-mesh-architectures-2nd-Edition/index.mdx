...
<BookWrapper>
<div className="book"><a href="https://www.nginx.com/resources/library/the-enterprise-path-to-service-mesh-architectures/"><img className="card" width="300px" src={service_mesh_book_second_edition} align="centre" /></a>
<br />
