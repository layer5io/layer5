...
import service_mesh_book from "./service-mesh-patterns.png"


<BookWrapper>

<div className="book"><a href="https://www.oreilly.com/library/view/service-mesh-patterns/9781492086444/"><img className="card" width="300px" src={istio_book} align="center" /></a><div>&nbsp;</div>
    <Button primary className="banner-btn one pa-8" title="Get the Book" url="hhttps://www.oreilly.com/library/view/service-mesh-patterns/9781492086444/ external="true"  />
</div>
