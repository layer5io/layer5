...
<div className="book-1"><a href={service_mesh_ent_book}><img className="card" width="300px" src={service_mesh_ent_book} alt="The-Enterprise-Path-to-Service-Mesh-Architectures" align="center" /></a><div>&nbsp;</div>
  <div >
