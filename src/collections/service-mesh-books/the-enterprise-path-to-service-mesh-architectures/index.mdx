...
import service_mesh_book from "./The-Enterprise-Path-to-Service-Mesh-Architectures.png"
...
<div className="book"><a href={service_mesh_book}><img className="card" width="300px" src={service_mesh_book} alt="The-Enterprise-Path-to-Service-Mesh-Architectures" align="centre" /></a><div>&nbsp;</div>
