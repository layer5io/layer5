...
<BookWrapper>
<SEO title="The Enterprise Path to Service Mesh Architectures" description="Approaches to service mesh deployments and an explanation of service meshes in contrast to related technologies." image={service_mesh_book} />
