...
<strong>BFE</strong>
<p>
  <a href="https://github.com/bfenetworks/bfe">BFE</a> is a Golang-based modern proxy. HTTP, HTTPS,
...
<strong>NGINX</strong>
<p>
  <a href="https://github.com/nginxinc/nginmesh">nginMesh</a> project deploys NGINX as a sidecar
...
<p>
  ...
  <Link to="/landscape">service mesh landscape</Link>, maintained by the community.
</p>
