...
<ul>
  <li>
    <Link to="/projects/cloud-native-performance">Service Mesh Performance</Link> (SMP) is a format
  ...
  <li>
    <Link to="/projects/service-mesh-interface-conformance">Service Mesh Interface</Link> (SMI) is a
...
<div class="fact-left">
  <p>
    See the Layer5 <Link to="/service-mesh-landscape">service mesh landscape</Link> for a
