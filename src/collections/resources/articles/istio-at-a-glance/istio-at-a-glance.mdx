...
<p>
  The <strong>data plane</strong> in Istio intercepts each packet in the request and performs health
...
<p>
  Istio's <strong>control plane</strong> provides a single point of administration for service
