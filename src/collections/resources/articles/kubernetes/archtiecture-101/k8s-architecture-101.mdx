...
<div className="right" >
<img src={ArchDiagram} align="centre" height="50%" alt="Simple Kubernetes Architecture Diagram" />
...
### Etcd Storage
Etcd isan open-source key-value data store that can be accessed by all nodes in the cluster. It stores configuration data of the cluster’s state. etcd is a simple, distributed, consistent key-value store. It’s mainly used for shared configuration and service discovery.
