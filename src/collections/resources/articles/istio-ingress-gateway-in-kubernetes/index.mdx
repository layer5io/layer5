...
<h2>Ingress Gateway Deployment</h2>
...
<p>A general configuration for an HTTP(s) service</p>
...
<p>First we will use istioctl to check the configuration status of Istio Ingress Gateway:</p>
