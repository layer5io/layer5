...
import BookinfoWith from "./bookinfo-with-proxies.png";
import BookinfoWithout from "./bookinfo-without-proxies.png";
import Architecture from "./istio-arch.png";
...
<img src={Architecture} class="image-center" alt="BookInfo without proxies" />
