...
<ResourcesWrapper>
  <div className="intro">
    <p> 
      ...
      <Link className="blog" to="https://www.nxtbook.com/nxtbooks/ieee/bridge_issue3_2021/index.php#/p/16">Analyzing Service Mesh Performance</Link> - Published in issue 3 of IEEE Bridge October 2021
    </p>
  </div>
