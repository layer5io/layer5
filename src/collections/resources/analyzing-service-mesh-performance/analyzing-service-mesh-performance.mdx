...
<div className="right" >
<img src={cover} align="center" width="400" height="500" max-width="100%" alt="IEEE The Bridge 2021 Issue 3 cover" />
</div>
...
<a href={EWtraffic}>
<img src={EWtraffic} align="center" width="500" height="300" max-width="100%" alt="EWtraffic" />
</a>
</div>
...
<div className="center" >
<a href={Code}>
<img src={Code} align="center" max-width="100%" alt="Code-snippet" />
</a>
</div>
...
<div className="center" >
<a href={Workload}>
<img src={Workload} align="center" width="500" height="300" max-width="100%" alt="Workload" />
</a>
</div>
...
<div className="center" >
<a href={Archictures}>
<img src={Archictures} align="center" width="500" height="300" max-width="100%" alt="Archictures-client" />
</a>
</div>
...
<img src={NetworkFunction} align="center" width="500" height="300" max-width="100%" alt="comparison of Network functions" />
</a>
</div>
