...
<ResourcesWrapper>
  <div className="intro">
    <p> 
      ...
      <img src="{cover}" align="right" alt="IEEE The Bridge 2021 Issue 3 cover" />
    </p>
  </div>
...
<img src={EWtraffic} align="right" alt="EWtraffic" />
...
<img src={Code} align="right" alt="Code-snippet" />
...
<img src={Workload} align="right" alt="Workload" />
...
<img src={Archictures} align="right" alt="Archictures-client" />
