...
<ResourcesWrapper>
  <p>
    ...
    , catch guest <Link to="https://layer5.io/community/members/lee-calcote">Lee Calcote</Link> from
    Layer5 and host Alan Shimel discuss the power of <Link to="/projects">Layer5 projects</Link> in
