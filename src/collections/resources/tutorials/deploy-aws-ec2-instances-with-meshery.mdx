...
thumbnail: ./aws-controllers/aws-ec2.webp
darkthumbnail: ./aws-controllers/aws-ec2.webp
...
import controllerChart from "./aws-controllers/controller-chart.webp";
import awsConnection from "./aws-controllers/aws-connection.webp";
import configureSecret from "./aws-controllers/configure-secret.webp";
...
<img src={awsConnection} alt="Connect Minikube Cluster" />
...
<img src={controllerChart} alt="EC2 Controller Chart" />
</figure>
...
1. Under **Data**, add the base 64 encoded values of your AWS keys.
   ...
   <img src={configureSecret} alt="Configure Secret" />
...
1. Once the deployment is complete, click **Open in Visualizer** to switch to Operator mode and see a pre-filtered view of your just deployed resources in the cluster. Alternatively, you can click _Operate_ at the top of the Kanvas to enter Operater mode.
   ...
   ![Operator Mode](./aws-controllers/controller-operator-mode.webp)
