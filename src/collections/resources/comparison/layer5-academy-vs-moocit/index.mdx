...
|---------|--------|--------|-------|
| Content Variety | ✅ | ✅ | Support text, images, videos, PDFs |
| Interactive Learning | ✅ | ✅ | Quizzes, tests, self-assessment |
| Learning Paths/Tracks | ✅ | ✅ | Support sequential paths and prerequisites |
| Course Publishing | ✅ | ✅ | Moocit's approach is web-based with incremental instant releases. Layer5 approach to content creation and publishing is gitflow based with version-controlled publishing.  |
...
| Public Catalog | ❌ | ✅ | Moocit lacks browsable, public catalog. Layer5 provides comprehensive discoverability;  |
...
| Social Learning | ✅ | ✅ | Forums, discussions, and Slack. |
...
| Hands-on Labs | ❌ | ✅ | Layer5 emphasizes real-time collaboration through Kanvas|
