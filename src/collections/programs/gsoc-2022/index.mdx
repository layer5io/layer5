...
<img src={playground} alt="The cloud native playground mockup" />

<p>
<b>Goal:</b> Create the world’s cloud native playground<br />
...
<div id="layer5-intro" className="iframe-container">
  <iframe
    width="392"
    height="220.5"
    src="https://www.youtube-nocookie.com/embed/0yN5T5LB9ps"
    loading="lazy"
    frameBorder="0"
