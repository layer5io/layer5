...
<div>
  ...
  <ul>
    ...
    <li>
      ...
      <a href="https://twitter.com/lcalcote" target="_blank" rel="noreferrer">
        @lcalcote
      </a>
      ), Otto van der Schaaf (<a
        href="https://twitter.com/oschaaf"
        target="_blank"
        rel="noreferrer">
        @oschaaf
      </a>)
    ...
    <li>
      <b>Issue(s)</b>:
      <a
        href="https://github.com/envoyproxy/envoy-perf/issues/72"
        target="_blank"
        rel="noreferrer">
        {" "}
        https://github.com/
...
<div>
  ...
  <ul>
    <li>
      ...
      (
      <a
        href="https://github.com/envoyproxy/envoy-wasm"
        target="_blank"
        rel="noreferrer">
    ...
    <li>
      ...
      <a href="https://twitter.com/lcalcote" target="_blank" rel="noreferrer">
        ...
        href="https://twitter.com/kumarabd"
        target="_blank"
        rel="noreferrer">
        @kumarabd
      </a>)
    ...
    <li>
      ...
      <a
        href="https://github.com/openservicemesh/osm/issues/1671"
        target="_blank"
        rel="noreferrer">
        {" "}
        https://github.com/
...
<div>
  ...
  <ul>
    ...
    <li>
      <b>Upstream Issue (URL)</b>:
      <a
        href="https://github.com/servicemeshinterface/smi-spec/issues/212"
        target="_blank"
        rel="noreferrer">
        {" "}
        https://github.com/
