...
<div>
  ...
  <ul>
    <li>
      ...
      same cloud native, 2) hetrogenius workloads (Kubernetes, VMs, Bare metal)
      using the same cloud native, 3) multiple Kubernetes clusters using
      different cloud nativees (e.g. Istio and Linkerd), 4) heterogeneous
      workloads using different cloud nativees (e.g. Istio, Consul).
    </li>
    <li>
