...
<p>Google <a href="https://developers.google.com/season-of-docs">Season of Docs</a> gives technical writers an opportunity to work with open source projects. Layer5 is participating in the Season of Docs. See below for a list of project ideas.</p>
<h3>Program Maintainers</h3>
<ul>
    <li>Navendu Pottekkat (<a href="https://github.com/navendu-pottekkat">@navendu-pottekkat</a>)</li>
...
<p><strong>Complete Set of Project Docs</strong></p>
<ul>
