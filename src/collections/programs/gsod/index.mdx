...
Project: API Docs for Meshery’s Cloud NativePatterns Playground
</h4>
<br />
<h3>Layer5</h3>
...
Participation in GSoD will be most meaningful to the community. The cloud native playground will be the first of its kind. Similar in nature to https://labs.play-with-docker.com, but with a full, interactive set of API documentation to accompany the learner. 
...
### About the project
<br />
<p><i>Goal: Create the world’s Kubernetes playground.</i></p>

<p>Meshery’s genesis is that of helping teach people about cloud native technology and enabling to operate this type of cloud native infrastructure confidently. The proposed project is aimed at furthering this mission with interactive API documentation connected to a Kubernetes learning playground (a running instance of Meshery). This project sits squarely in the crosshairs of our purpose - both for Meshery and Layer5.</p>

### The project’s scope

<p>We will create a new set of interactive documentation for Meshery users to both learn how to use Meshery, but also confidently adopt and operate any cloud native tech. We have a number of community volunteers lined up and committed to collaboration on the creation of this CNCF playground. The technical writer will collaborate with other engineers, working with Swagger and Docusaurus.</p>
