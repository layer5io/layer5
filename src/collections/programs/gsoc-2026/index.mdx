...
<img src={playground} alt="Meshery Cloud Native Playground" style={{ width: "40%" }} />
</a>

<p>
  The <a href="https://play.meshery.io">Cloud Native Playground</a> provides a
  browser-based environment for exploring Meshery and cloud native technologies
  without a local Meshery installation.
</p>
