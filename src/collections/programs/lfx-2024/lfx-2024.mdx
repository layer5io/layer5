...
<div>
  ...
  <ul>
    <li className="lfx-timeline_terms">
...
Layer5 is all about <Link to="/community">its community</Link> of contributors. We have designed an
onboarding program customized to <Link to="/community/newcomers">meet newcomers</Link> where they’re
at and developed an onboarding buddy program, <Link to="/community/meshmates">MeshMates</Link> with
...
<div className="apply-button">
  <h3>
    <Button primary title="Participate" url="https://slack.layer5.io" external={true} />
  </h3>
</div>
