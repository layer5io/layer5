...
<div>
    ...
    <ul>
        <li>
            <b>Description</b>: Ensure that a cloud infrastructure is properly configured
...
<b>Mentor(s)</b>: Lee Calcote (<a href="https://twitter.com/lcalcote">@lcalcote</a>)
        ...
        <li>
            <b>Issue(s)</b>:
            <a href="https://github.com/servicemeshinterface/smi-spec/issues/70 ">https://github.com/<wbr/>servicemeshinterface/<wbr/>smi-spec/issues/70</a>
        </li>
        <li>
            <b>Mentee: </b>
...
<div>
    ...
    <ul>
        ...
        <li><b>Recommended Skills</b>: Golang, Kubernetes</li>
        <li>
            <b>Mentor(s)</b>: Prateek Sahu (<a href="https://twitter.com/prateeksahu22">@PrateekSahu22</a>), Kanishkar J (<a href="https://twitter.com/_kanishkarj_">@_kanishkarj_</a>)
        </li>
        <li>
            <b>Issue(s)</b>:
            <a href="https://github.com/envoyproxy/envoy-perf/issues/72">https://github.com/<wbr/>envoyproxy/<wbr/>envoy-perf/issues/72</a>
        </li>
    </ul>
</div>
<div>&nbsp;</div>
