...
<ProgramsWrapper>
  ...
  <p>
    ...
    <a href="https://communitybridge.org/">CommunityBridge</a> is building a
    healthy ecosystem around the open source software by funding projects,
    securing code, and connecting with talented developers. Layer5 is
    participating in the CommunityBridge's mentorship program since 2019.
  </p>
  <b>Projects</b>
  <br />
  <div>
    ...
    <ul>
      ...
      <li>
        <b>Recommended Skills</b>: Golang (nice to have: Kubernetes, Service
        Mesh)
      </li>
      <li>
  ...
  <p>
    ...
    service mesh projects and their maintainers in the world. We build projects
