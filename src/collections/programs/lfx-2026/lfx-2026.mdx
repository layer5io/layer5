...
import LfxLogoLight from "./Linux_Foundation_logo.svg";
import { Link } from "gatsby";
import LfxPageNav from "./LfxPageNav";
import { useStyledDarkMode } from "../../../theme/app/useStyledDarkMode";

export const LfxLogoImage = () => { const { isDark } = useStyledDarkMode(); return <img src={isDark ? LfxLogo : LfxLogoLight} alt="LFX logo" className="lfx_logo"/>; };
...
<ul>
    <li className="lfx-timeline_terms"><strong>Spring Term: March 2nd - May 29th</strong></li>
  <ul>
    <li>mentorships available on LFX Mentorship: Jan 26th, 2026</li>
    <li>applications open: Jan 26th - Feb 10th, 2026 (2 weeks)</li>
    <li>application review/admission decisions/HR paperwork: Feb 11th - Feb 24th, 2026</li>
  </ul>
</ul>
<ul>
  <li className="lfx-timeline_terms"><strong>Summer Term: June 8th - August 31st</strong></li>
  <ul>
    <li>mentorships available on LFX Mentorship: May 5th, 2026</li>
    <li>applications open: May 5th - May 19th, 2026 (2 weeks)</li>
    <li>application review/admission decisions/HR paperwork: May 20th - June 2nd, 2026</li>
  </ul>
</ul>
<ul>
  <li className="lfx-timeline_terms"><strong>Fall Term: September 7th - Nov 27th</strong></li>
  <ul>
    <li>mentorships available on LFX Mentorship: August 3rd, 2026</li>
    <li>applications open: August 3rd - August 18th, 2026 (2 weeks)</li>
    <li>application review/admission decisions/HR paperwork: August 19th - September 1st, 2026</li>
  </ul>
</ul>
...
<h2 id="spring-2026">LFX Mentorship 2026 Spring Projects</h2>
<br />
...
<h2 id="summer-2026">LFX Mentorship 2026 Summer Projects</h2>
<br />
...
<h2 id="fall-2026">LFX Mentorship 2026 Fall Projects</h2>
<br />
...
- **Technologies and Required/Desirable Skills:** Golang, React, vector search, REST, SQL, Kubernetes CRDs

- **Mentors:** 
  - Mia Grenell | @miacycle | mia.grenell2337@gmail.com | mia.grenell
  - Lee Calcote | @leecalcote | leecalcote@gmail.com | leecalcote

- **Upstream Issue URL:** [https://github.com/meshery/meshery/issues/20995](https://github.com/meshery/meshery/issues/20995)

- **LFX program URL:** [CNCF - Meshery: Grounding AI in the Meshery Registry (2026 Term 3)](https://mentorship.lfx.linuxfoundation.org/project/45b2ab48-4925-41eb-b91d-87f2e74be320)
...
- **Technologies and Required/Desirable Skills:** Golang, Model Context Protocol, REST, GitHub Actions, Kubernetes

- **Mentors:** 
  - Lee Calcote | @leecalcote | leecalcote@gmail.com | leecalcote
  - Yi Nuo | @yi-nuo426 | yinuo084@gmail.com| yinuo

- **Upstream Issue URL:** [https://github.com/meshery/meshery/issues/19446](https://github.com/meshery/meshery/issues/19446)
...
- **Technologies and Required/Desirable Skills:** Golang, Javascript, React, REST, Frontier model provider APIs / LLM provider APIs, Kubernetes

- **Mentors:** 
  - Lee Calcote | @leecalcote | leecalcote@gmail.com | leecalcote
  - James Horton | @hortison | james.hortison2337@gmail.com | hortison

- **Upstream Issue URL:** [https://github.com/meshery/meshery/issues/20994](https://github.com/meshery/meshery/issues/20994)
...
- **Technologies and Required/Desirable Skills:** Golang, Cobra, JSON/YAML/TOON, GitHub Actions, Kubernetes

- **Mentors:**
  - Lee Calcote | @leecalcote | leecalcote@gmail.com | leecalcote
  - Yi Nuo | @yi-nuo426 | yinuo084@gmail.com| yinuo

- **Upstream Issue URL:** [https://github.com/meshery/meshery/issues/20979](https://github.com/meshery/meshery/issues/20979)

- **LFX program URL:** [CNCF - Meshery: AXI - Making mesheryctl Agent-Native (2026 Term 3)](https://mentorship.lfx.linuxfoundation.org/project/82c28ded-28c6-4089-8d6a-5e9dcf7f1c11)
