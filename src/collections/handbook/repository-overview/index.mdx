...
description: "Overview of GitHub organizations and repositories in the Layer5 community"
type: Handbook
---
...
export const contents = [
  { id: 0, link: "#top", text: "GitHub Organizations and Repositories" },
...
<ul className="project-org-list">
  ...
  <li>
    ...
    <img src={MesheryOperator} alt="Meshery Operator logo" style={{ marginLeft: ".25rem",height: "1.5rem" }} /> Meshery Operator
    <img src={MeshSync} alt="mesh sync icon" style={{ marginLeft: ".25rem",height: "1.5rem" }} /> and MeshSync.
  </li>
  ...
  <li>
    ...
    <img src={Kanvas} alt="Kanvas logo" style={{ height: "1.5rem" }} /> Kanvas.
  </li>
  <li>
    <a href="https://github.com/meshery-extensions">
      <img src={mesheryExtensionsIcon} alt="meshery extension icon" />
      &nbsp; Meshery Extensions
    </a>
  ...
  <li>
    <a href="https://github.com/orgs/layer5io/repositories?q=academy">
      <img src={layer5AcademyIcon} alt="Layer5 Academy logo" />
      &nbsp; Layer5 Academy
    </a>
