...
<div style="margin-left: 50px; margin-top: -30px; display: flex; justify-content: flex-start center">
  <div>
  ...
  <div style="margin:auto;">
    <h2 class="l5-dark-grey-text" style="text-align: center;font-weight: bold;">
...
<div class="row">
  ...
  <div class="half-col" style="max-width:50%">
    <iframe
...
<div style="display: flex; justify-content:center;">
  <h4 class="black-text center" style="font-size: 1.5rem;">
    ...
    <iframe style="margin: auto;" width="560" height="315" src="https://www.youtube.com/embed/rgnb0-ntPko"
...
<div class="row" style="vertical-align: bottom; margin: auto;">
...
<div class="post-content" style="padding: 2em;" itemprop="articleBody">
  <div class="row">
    ...
    <div class="post-content col s8 m6" style="vertical-align: bottom; margin: auto; padding-top: 100px;">
