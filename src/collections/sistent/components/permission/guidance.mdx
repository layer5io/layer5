...
<ul>
  <li>
    <strong>Consistent Badge Placement:</strong> Place the lock badge at the bottom-left corner of the parent component to keep visual styles consistent across the app.
  </li>
  <li>
