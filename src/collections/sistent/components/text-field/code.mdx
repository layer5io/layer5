...
<div className="showcase">
  ...
  <CodeBlock name="tf-form-props" collapsible code={codes[0]} />
</div>
...
<div className="showcase">
  ...
  <CodeBlock name="tf-validation" collapsible code={codes[1]} />
</div>
...
<div className="showcase">
  ...
  <CodeBlock name="tf-multiline" collapsible code={codes[2]} />
</div>
...
<div className="showcase">
  ...
  <CodeBlock name="tf-sizes" collapsible code={codes[3]} />
</div>
...
<div className="showcase">
  ...
  <CodeBlock name="tf-full-width" collapsible code={codes[4]} />
</div>
