...
component: toolbar
description: A toolbar is a container for a set of controls or actions related to the current context or page. It helps users quickly access common functions or navigate within an application.
---
...
export const ActionToolbarDemo = () => (
  <Row $Hcenter className="image-container">
    <Toolbar>
...
export const ContextualToolbarDemo = () => {
...
export const BottomToolbarDemo = () => (
  <Row $Hcenter className="image-container">
    <Col sm={12}>
      <div style={{
        border: "1px solid",
