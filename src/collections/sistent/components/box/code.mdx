...
<div className="showcase">
  ...
  <CodeBlock name="box-basic" collapsible code={`<Box sx={{ bgcolor: "#ffeb3b", padding: 4, height: "50vh" }}>
    <p>
...
<div className="showcase">
  ...
  <CodeBlock name="box-styled" collapsible code={`<Box
    sx={{
...
<div className="showcase">
  ...
  <CodeBlock name="box-responsive" collapsible code={`<Box
    sx={{
      bgcolor: { xs: "#cfe8fc", md: "#ffeb3b" },
      padding: { xs: 2, md: 4 },
      height: "50vh",
...
<div className="showcase">
  ...
  <CodeBlock name="box-interactive" collapsible code={`<Box
    sx={{
      bgcolor: "#cfe8fc",
      height: "50vh",
      padding: 4,
