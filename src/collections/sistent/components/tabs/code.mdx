...
title: Tabs Code
component: tabs
description: Here are code examples for all different variations and props of the Tabs component. Each example shows the implementation with a live preview and copyable code.
---
...
colors: `import { Tabs, Tab, Box, SistentThemeProvider } from "@sistent/sistent";
import { useStyledDarkMode } from "../../../../theme/app/useStyledDarkMode";
...
export const FullWidthTabsDemo = () => {
...
export const ControlledTabsDemo = () => {
    ...
    <Box>
      ...
      <Box sx={{ mt: 2 }}>
        <button
          ...
          style={{ padding: "8px 16px", cursor: "pointer", borderRadius: "4px", border: "1px solid var(--border-color)", background: "var(--background-secondary)", color: "var(--text-primary)" }}
        >
          Next Step
        </button>
      </Box>
...
<div className="showcase">
  ...
  <CodeBlock name="basic-tabs" collapsible code={codes.basic} />
</div>
...
<div className="showcase">
  ...
  <CodeBlock name="scrollable-tabs" collapsible code={codes.scrollable} />
</div>
...
<div className="showcase">
  ...
  <CodeBlock name="fullwidth-tabs" collapsible code={codes.fullWidth} />
</div>
...
<div className="showcase">
  ...
  <CodeBlock name="vertical-tabs" collapsible code={codes.vertical} />
</div>
...
<div className="showcase">
  ...
  <CodeBlock name="icon-tabs" collapsible code={codes.icon} />
</div>
...
<div className="showcase">
  ...
  <CodeBlock name="disabled-tabs" collapsible code={codes.disabled} />
</div>
...
<div className="showcase">
  ...
  <CodeBlock name="colored-tabs" collapsible code={codes.colors} />
</div>
...
<div className="showcase">
  ...
  <CodeBlock name="controlled-tabs" collapsible code={codes.controlled} />
</div>
...
<div className="showcase">
  ...
  <CodeBlock name="wrapped-tabs" collapsible code={codes.wrapped} />
</div>
