  ...
  <ThemeWrapper>
    <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
      <Grid2 container spacing={2} sx={{ width: "100%", maxWidth: 600 }} minHeight={120}>
        <Grid2 display="flex" justifyContent="center" alignItems="center" size="grow" sx={{ border: "1px dashed", borderColor: "grey.400" }}>
  ...
  <ThemeWrapper>
    <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
      <Grid2 container spacing={2} direction="row" sx={{ width: "100%", maxWidth: 600 }}>
        <Grid2 size={3}><Item>1</Item></Grid2>
        <Grid2 size={3}><Item>2</Item></Grid2>
        <Grid2 size={3}><Item>3</Item></Grid2>
        <Grid2 size={3}><Item>4</Item></Grid2>
      </Grid2>
    </div>
  </ThemeWrapper>
</Row>
  ...
  <ThemeWrapper>
    <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
      <Grid2 container spacing={2} direction="column" sx={{ width: "100%", maxWidth: 200, height: 300 }}>
        <Grid2 size="grow"><Item>1</Item></Grid2>
        <Grid2 size="grow"><Item>2</Item></Grid2>
        <Grid2 size="grow"><Item>3</Item></Grid2>
        <Grid2 size="grow"><Item>4</Item></Grid2>
      </Grid2>
    </div>
  </ThemeWrapper>
</Row>
  ...
  <ThemeWrapper>
    <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
      <Grid2 container spacing={2} wrap="wrap" sx={{ width: "100%", maxWidth: 300 }}>
        <Grid2 size={4}><Item>Item 1</Item></Grid2>
        <Grid2 size={4}><Item>Item 2</Item></Grid2>
        <Grid2 size={4}><Item>Item 3</Item></Grid2>
        <Grid2 size={4}><Item>Item 4</Item></Grid2>
      </Grid2>
    </div>
  </ThemeWrapper>
</Row>
