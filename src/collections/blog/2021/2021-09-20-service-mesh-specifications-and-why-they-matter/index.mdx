...
<img src={Abstractions} className="slides-left" alt="abstractions" />
...
<img src={Journey} className="slides-right" alt="journey-image" />
...
### Service Mesh Interface
<img src={SMI} className="slides-left" alt="smi-image" />
<ul>
...
<img src={Graph} className="slides-left" alt="graph" />
<ul>
...
### Service Mesh Performance
<img src={SMP} className="slides-right" alt="smp-image" />
<ul>
...
<img src={Flowchart} className="slides-left" alt="flowchart" />
<ul>
  ...
  <img src={Bucket} className="slides-right" alt="graph" />
...
<img src={Hamlet} className="slides-left" alt="hamlet-image" />
<ul>
