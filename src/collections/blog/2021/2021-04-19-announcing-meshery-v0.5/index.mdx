...
<p>The Meshery Adapter Library provides a common and consistent set of functionality for managing the lifecycle of infrastructure and their workloads.</p>
<div class="img-center">
...
As a Kubernetes custom controller, Meshery Operator provides a Kubernetes-native approach to interfacing with Meshery. Kubernetes is where some infrastructure has gotten their initial foothold, and therefore, important that Meshery interface to Kubernetes natively.</p>
<p>Some infrastructure supports non-containerized workloads outside of the cluster and will grow in this focus over time. While Meshery Operator is Kubernetes only in the v0.5.0 release, Meshery's architecture makes considerations for different workload and platform types.</p>
...
<h3>MeshSync</h3>
<p>MeshSync is available as a Kubernetes custom resource that provides tiered discovery and continual synchronization with Meshery Server as to the state of the Kubernetes cluster, cloud services, and their workloads.</p>
...
<div class="intro"><p>If these topics excite you, come and say "Hi" on the community <Link to="http://slack.layer5.io">Slack</Link> and you are sure to be warmly welcomed. <span>😀</span></p></div>
