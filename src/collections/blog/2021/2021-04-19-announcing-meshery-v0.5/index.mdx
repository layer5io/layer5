...
<div class="intro" style="text-align:center; display:flex; flex-direction:row; flex-wrap: wrap; justify-content: center; align-items: center; align-content: center; margin: 2rem;">
  ...
  <p style="flex-basis: 50%; width:100%; padding: 0rem; margin:0rem; ">Thank you to the wonderful Layer5 community of open source contributors in making this significant release possible.
</div>

## New Service Mesh Support

<span class="bigfirstletter">2</span> new Meshery service mesh adapters are bundled with this latest version of Meshery: The Meshery Adapter for Traefik Mesh and the Meshery Adapter for NGINX Service Mesh.
...
<div class="intro" style="text-align:center;margin: 2rem 4rem;">Read <Link to="/community/members/michael-gfeller">Maintainer Michael Gfeller</Link>'s blog post <Link to="/blog/meshery/introducing-meshkit-and-the-meshery-adapter-library">Introduction MeshKit and the Meshery Adapter Library</Link> for more details.</div>
...
<div class="intro">If these topics excite you, come and say "Hi" on the community <Link to="http://slack.layer5.io">Slack</Link> and you are sure to be warmly welcomed. <span>😀</span></div>
