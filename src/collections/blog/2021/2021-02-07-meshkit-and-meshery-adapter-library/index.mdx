...
<Link to="https://github.com/layer5io/meshkit">MeshKit</Link> is simple and straight forward to use,
...
<div class="intro">
  <p>
    ...
    come and say "Hi" on the community <Link to="http://slack.layer5.io">Slack</Link> and you are
    sure to be warmly welcomed. <span>😀</span>
  </p>
</div>
