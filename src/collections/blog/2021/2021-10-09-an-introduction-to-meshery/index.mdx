...
<img src={Planes} className="slides-right" alt="network-planes" />
<p>
...
<p>
  ...
  for each of the{" "}
  <a href="https://docs.meshery.io/getting-started/overview">
    supported models.
  </a>
  :{" "}
</p>
...
<img src={Patterns} className="slides-left" alt="Patterns" />
<h3>
  <img
    src={PatternsLogo}
    alt="patterns-logo"
...
<img src={Nighthawk} className="slides-right" alt="Nighthawk" />
