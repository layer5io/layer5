...
<p align="center"><img src={smidashboard} className="image-center-shadow" style={{ width: "70%" }} alt="smi conformance dashboard" /> <br /><i>Meshery's Service Mesh Interface Conformance Results</i></p>
