...
<div className="intro">
  <p>
    ...
    <Link className="highlight" to="/careers/programs">
...
<p>
  ...
  <Link to="/projects/service-mesh-interface-conformance">SMI Conformance</Link> works and the{" "}
  <Link className="mute" to="https://layer5.io/projects/cloud-native-performance">
...
<p>
  ...
  <Link to="/community/newcomers">Newcomers</Link> meeting. I was introduced to a lot of things that
