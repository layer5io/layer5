...
<div class="intro ">
  <p>
    ...
    <Link to="/projects/cloud-native-performance"> Service Mesh Performance</Link> and
    <Link to="/service-mesh-landscape"> Service Mesh Landscape</Link>. He works with React, Gatsby,
...
<div class="interviewee">
  ...
  <p>
    ...
    <Link to="/community/members/tanuj-agarwal"> Tanuj </Link> was part of Layer5, and I thought of
    ...
    response was <Link to="/community/members/lee-calcote"> Lee </Link> giving an overly positive
    reaction.
  </p>
</div>
...
<div class="interviewee">
  ...
  <p>
    ...
    <Link to="/community/members/lee-calcote"> Lee </Link> and
    <Link to="/community/members/nikhil-ladha"> Nikhil </Link>, were quite helpful for the team to
...
<p class="centered-text">
  "Be like Jash." Join the <a href="http://slack.layer5.io">Layer5 Slack</a> and say hi.
</p>
