...
<div className="interviewee">
  ...
  <p>
    ...
    was <Link to="/community/members/lee-calcote"> Lee </Link> giving an overly positive
    reaction.
  </p>
</div>
...
<div className="interviewee">
  ...
  <p>
    ...
    <Link to="/community/members/nikhil-ladha"> Nikhil </Link>, were quite helpful
    for the team to bring it through 6 months.
  </p>
</div>
