...
- <b><a href="https://www.youtube.com/watch?v=pIFSI7xtwFs" target="_blank">Meshery Development Metting (Nov 4th, 2020)</a></b> where I gave a demo running UI tests on the Meshery project (<a href="https://docs.google.com/presentation/d/1QbMEyQgbXMLvvSheAIDruzCFe8SmBrKXUjqP0Hxfqjw" target="_blank">slides</a>)
- <b><a href="https://docs.cypress.io/examples/examples/tutorials.html" target="_blank">Tutorial Videos</a></b> from Cypress blog.
- The <b><a href="https://www.youtube.com/watch?v=5XQOK0v_YRE" target="_blank">Brian Mann – I see your point, but… (Part 1)</a></b> YouTube video where he gives pro tips writting tests in Cypress.

If you have questions, do not hesitate to ask to the Meshery community on Slack :)

Happy testing!

\- _[Rodolfo Martínez Vega](/community/members/rodolfo-martinez)_
