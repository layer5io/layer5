...
{" "}
    are committed to helping community members be successful contributors.
    MeshMates aid in identifying areas of projects to engage within, working
    groups to join, and in helping community members grow in their open source
    and cloud native knowledge. By connecting one-on-one, MeshMates will share
...
<img src={Tanuj} className="image-right" alt="tanuj-agarwal" />
<p>
...
<img src={Kelechi} className="image-right" alt="kelechi-precious" />
<p>
...
<img src={Ruth} className="image-right" alt="ruth-ikegah" />
<p>
  ...
  <Link to="https://github.com/layer5io">GitHub repository</Link> and hopped on
...
<p>
  ...
  to get right and assigned me a MeshMate, Ashis Singh (read saviour 😳). I sent
