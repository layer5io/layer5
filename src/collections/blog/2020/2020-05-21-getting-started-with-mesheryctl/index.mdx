...
<table className="table-1" align="center">
  ...
  <tbody>
    <tr>
      <td>
        <a href="https://docs.meshery.io/installation/platforms/docker">Docker</a>
      </td>
    ...
    <tr>
      <td>
        {" "}
        - <a href="https://docs.meshery.io/installation/platforms/docker">Docker - Docker App</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
      <td>
        <a href="https://docs.meshery.io/installation/platforms/kubernetes">Kubernetes</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
      <td>
        {" "}
        - <a href="https://docs.meshery.io/installation/platforms/aks">Kubernetes - AKS</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
      <td>
        {" "}
        - <a href="https://docs.meshery.io/installation/quick-start">Kubernetes - Docker Desktop</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
      <td>
        {" "}
        - <a href="https://docs.meshery.io/installation/platforms/eks">Kubernetes - EKS</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
      <td>
        {" "}
        - <a href="https://docs.meshery.io/installation/platforms/gke">Kubernetes - GKE</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
      <td>
        {" "}
        -{" "}
        <a href="https://docs.meshery.io/installation/platforms/kubernetes#helm">
          Kubernetes - Helm
        </a>
      </td>
      <td className="text-centre">✔️</td>
    ...
    <tr>
      <td>
        {" "}
        -{" "}
        <a href="https://docs.meshery.io/installation/platforms/minikube">Kubernetes - Minikube</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>
        <a href="https://docs.meshery.io/installation/quick-start">Linux</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
      <td>
        <a href="https://docs.meshery.io/installation/quick-start">Mac</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
      <td>
        {" "}
        - <a href="https://docs.meshery.io/installation/mesheryctl#homebrew">Mac - Homebrew</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
      <td>
        <a href="https://docs.meshery.io/installation/platforms/windows">Windows</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
      <td>
        {" "}
        - <a href="https://docs.meshery.io/installation/mesheryctl#scoop">Scoop</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
      <td>
        {" "}
        - <a href="https://docs.meshery.io/installation/platforms/windows#wsl">WSL2</a>
      </td>
      <td className="text-centre">✔️</td>
    </tr>
    <tr>
...
<br />
We believe we have not missed any of the popular platforms for what it’s worth, we will be rolling
out support for RaspberryPi and OpenShift soon 🎉🎉🎉.
...
<table align="center" className="table-box">
  <tbody>
    <tr>
      <td className="text-centre">a running Docker daemon</td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr>
      <td className="text-centre">
        One of the most interesting sub-commands of <code>mesheryctl</code> is{" "}
        <strong>
          <code>perf</code>
        </strong>
        .
