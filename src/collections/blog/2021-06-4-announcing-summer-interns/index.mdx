...
<BlogWrapper>
  ...
  <div className="intro">
    <p>
      ...
      <Link className="blog" to="/careers/programs">open source internship programs</Link>. We seek out existing contributors who
...
Hear about their journeys and follow along this summer as they make waves in the Layer5 community.
  ...
  <p>
    ...
    At first I thought that I should just work on layer5.io or maybe getNightHawk, but then I was given an opportunity to work on something that I had never done before. It has been around 4 months that I have been a part of the community and I am actively trying to add to the project attending weekly meetings where everyone shares amazing stuff about what they did.
  </p>
  <p>
