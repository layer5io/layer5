...
supporting [Cilium service mesh adapter](https://github.com/meshery/meshery-cilium) with Meshery, persisting <Link to="/kanvas">kanvas</Link> user preferences with 
