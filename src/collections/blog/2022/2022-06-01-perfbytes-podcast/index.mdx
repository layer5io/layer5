...
<img src={ConsulDemo} alt="Consul Kanvas Demo" className="slides-right" />
...
<h5>Does Kanvas allow you to load the current configuration that is has been applied in the current cluster?
</h5>
<div className="answer">
