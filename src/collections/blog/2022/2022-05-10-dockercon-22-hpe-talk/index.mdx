...
<div style={{display: "grid", gridTemplateColumns: "auto auto", padding: "10px"}}>
  ...
  <p style={{paddingBottom: "1.6rem"}}>
    ...
    <img src={designer} alt="Meshery Docker Extension MeshMap Designer" align="center" />
  </div>
  <div style={{padding: "20px", textAlign: "center"}}>
  <p>
    ...
    <img src={visualizer} alt="Meshery Docker Extension, MeshMap Visualizer" align="center"/>
  </div>
</div>
...
<Link to="/meshmap">Apply for MeshMap Beta Program</Link></p>
