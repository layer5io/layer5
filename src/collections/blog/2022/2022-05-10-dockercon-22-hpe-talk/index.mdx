...
import kanvasInDocker from './kanvas-docker-extension-for-meshery.webp';
...
<li><strong>Visual design of Kubernetes applications</strong> - Using <Link to="/kanvas">Kanvas</Link> as a visual topology for designing Docker Compose applications, operating Kubernetes, all Kubernetes operators, workloads, and custom resources.</li>
...
<p>
  <h3>Maximiliano demonstrates Kanvas</h3>
</p>

<img src={kanvasInDocker} alt="Layer5 Kanvas in Meshery Docker Extension" />
...
<div style="  display: grid;
  ...
  <p style="padding-bottom: 1.6rem;">
    ...
    <img src={designer} alt="Meshery Docker Extension" align="center" alt="Kanvas Designer" />
  ...
  <p>
    ...
    <img src={visualizer} alt="Meshery Docker Extension" align="center" alt="Kanvas Visualizer" />
  </div>
</div>
