...
<p>
  As a{" "}
  <Link to="https://www.docker.com/blog/docker-captain-take-5-lee-calcote/">
    Docker Captain
  </Link>
  , Lee has always been a proponent of Docker, particularly its enablement of
  developer workflows. Docker Extensions bring an integrated experience with
  ecosystem tooling like Meshery — a critical tool for developers configuring
