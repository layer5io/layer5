...
<div class="intro">
  <p>
    As a longstanding CNCF member, Layer5 has donated two of its open source projects to the CNCF: <Link to="/products/meshery">Meshery</Link> and Service Mesh Performance. We're hosting project office hours where you can learn more about each of the projects, and meet the project maintainers. 
  </p>
</div>
...
<p>
  <h5 style="display:inline;">October 26, 2022</h5>:&nbsp; <Link to="/products/meshery">Meshery</Link> is the open source, cloud native manager that enables the adoption, operation, and management of Kubernetes, any service mesh, and their workloads. Meshery is a multi-cluster Kubernetes manager hundreds of <Link to="/products/meshery/integrations">integrations</Link> supported for any workload or infrastructure components.
</p>
