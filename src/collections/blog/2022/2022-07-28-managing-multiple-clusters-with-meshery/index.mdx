...
import Cluster2 from "./kanvas-cluster2.webp";
import Cluster1 from "./kanvas-cluster1.webp";
...
You can switch between views of your cluster in visualizer mode while using <Link to="/kanvas">Kanvas</Link>.
