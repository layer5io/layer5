...
<img src={Projects} className="slides-right" alt="Tag Networks Projects" />
...
<p>
<img src={Smi} className="slides" style={{marginLeft: "10px"}} alt="SMI" />
<img src={Smp} className="slides" style={{marginLeft: "10px"}} alt="SMP" />
</p>
