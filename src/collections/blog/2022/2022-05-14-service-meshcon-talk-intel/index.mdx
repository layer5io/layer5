...
<p>
    <strong>
        Lee Calcote and Mrittika Ganguli covered all the concepts of SMP and MeshMark in this great talk. Learn more about MeshMark on the <Link to="https://meshery.io/service-mesh-interface">Service Mesh Performance </Link>website.
    </strong>
</p>
