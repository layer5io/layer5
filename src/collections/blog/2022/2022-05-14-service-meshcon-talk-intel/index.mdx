---
title: "MeshMark: Service Mesh value measurement"
date: 2022-05-17 10:30:05 -0530
author: Gaurav Chadha
thumbnail: ./banner.png
description: "ServiceMeshCon 2022 talk with Intel"
type: Blog
category: "MeshMark"
tags:
 - MeshMark
...
import MeshMapDemo from './meshmap-demo.png';
...
<h3>Lee demonstrates MeshMap with an example of console application</h3>

<p>
Let's take an example workload a console application, load it into the visual designer, take a look at the service splitting functionality of console and note in this case we're assigning a weight of three when we can change that to four to derive its mesh Mark which is a mesh utilization efficiency calculation of the efficiency by which that network function is being performed.
...
<Link to="/service-mesh-management/meshmap"></Link>
</p>
