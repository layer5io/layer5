...
import KanvasDemo from './meshmark-score.webp';
...
<img src={KanvasDemo} alt="Kanvas demo" style="width:40%;float:right;"  />
<h3>Lee demonstrates Kanvas with an example Consul application</h3>
