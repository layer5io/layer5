...
<img src={meshmarkSlide} className="slides" align="center" style="margin-left: 30px;" alt="meshmark"/>
<img src={example} className="slides" align="center" style="margin-left: 30px;" alt="meshmark example"/>
...
<p style="font-style:italic;font-size:1rem;margin-left:1rem;">MeshMark in Meshery (an excerpt from ServiceMeshCon EU 2022 demo)

</div>

<strong>Lee Calcote and Mrittika Ganguli covered all the concepts of SMP and MeshMark in this great talk. Learn more about MeshMark on the <Link to="https://meshery.io/service-mesh-interface">Service Mesh Performance </Link>website.</strong>
</BlogWrapper>
