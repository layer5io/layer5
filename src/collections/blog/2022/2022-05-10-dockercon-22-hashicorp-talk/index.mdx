...
description: "DockerCon 2022 talk with HashiCorp and Kanvas Demo"
category: "Docker"
tags:
 - Docker
 - Meshery
...
<p>
    <p>
    <h3>Lee Calcote introduces Kanvas</h3>
    </p>
        <img src={designer} alt="Kanvas Designer" style="width:50%;float:right;" />
Kanvas is the world's only visual designer for Kubernetes and all cloud native infrastructure. Collaborate with other engineers in real-time as you use Kanvas to design, deploy, and manage your Kubernetes-based deployments. Save time and use a design template. Take advantage of the best practices embedded in the patterns found in Meshery Catalog. Kanvas not only allows you to create and verify your cloud native application and infrastructure configurations, but to deploy and operate that infrastructure as well.

    Lee demonstrated Kanvas <strong>Designer</strong>  design capabilities using Consul Service Mesh as an eample and configures various Consul-specific features. He designs a service mesh deployment with application and Envoy filter from scratch. 
</p>
       <p>
       <img src={visualizer} alt="Kanvas Designer" style="width:50%;float:left;padding-right:30px;" />
     Kanvas <strong>Visualizer Mode</strong> allows you to examines a visual topology of Kubernetes cluster and its services. View and search log streams from your pod's containers. Connect an interactive terminal to instances of your containers.
       </p>

<p>
    To Lee's demo, Nic also added in the context of developer experience that Kanvas also makes it easy to do the job and with Meshery extension it makes it super easy to write and configure code without being worried for the developer environment.
    </p>
    <p>
...
<Link to="/kanvas">Apply for Kanvas Beta Program</Link>
</p>
