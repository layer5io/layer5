...
<img src={aadityaFirstPr} class="image-center-shadow" alt="Aaditya's first PR merged" />
...
<img src={aadityaPresenting} class="image-center-shadow" alt="Aaditya Presenting" /> 
