...
<p>The Layer community grows on a daily basis, which means that each day <Link to="/community/managers">community managers</Link>, <Link to="/community/meshmates">MeshMates, and other existing <Link to="/community/members">community members</Link> field the question of "how can I contribute to your project" any number of times everyday. The good news is that there are many what is to engage - all of which are important to the health of both the projects and the community.</p> 
