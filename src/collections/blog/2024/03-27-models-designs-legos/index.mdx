...
<ul>
	...
	<li><strong>Focus:</strong>&nbsp;Describe how to manage specific infrastructure types and their interactions.<img data-file-id="2445161" height="223" src={FiveLegos} style="border: 0px; width: 300px; height: 223px; margin: 0px;" width="300; box-shadow: none;" className="image-right-no-shadow" /></li>
...
{/* <img src={FiveInstructions} className="img-right"></img> */}
