...
- **From Scratch**: Open the “Design” tab, select and arrange components on the Kanvas, and customize with connections, labels, and properties. When satisfied, save your design.
