...
<p>
  ...
  <a href="https://docs.meshery.io/installation#install-mesheryctl">following the instructions</a>.
</p>
...
<p>
  ...
  <Link to="/company/news/layer5-joins-docker-extension-program-bringing-kubernetes-and-service-mesh-management-to-docker-with-meshery">
    Layer5 and Docker
  </Link>
...
<p>
  ...
  <a href="https://hub.docker.com/extensions/meshery/docker-extension-meshery">Docker Hub</a> and
