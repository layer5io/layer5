---
title: "Docker Build Checks Failures"
subtitle: "Ensuring Best Practices and Avoiding Warnings"
date: 2024-10-09
author: Lee Calcote
...
description: "Docker build fails with warning: FromAsCasing: ‘as’ and ‘FROM’ keywords’ casing do not match. Learn how to fix this and other build check warnings."
type: Blog
category: Docker
tags:
  - Docker
