...
<div class="intro" style="text-align:center;display:flex;margin: 4rem;padding:2rem;padding-bottom:1rem;">
...
<img style="display: inline; float: left; max-width:300px; width:20%; padding: 1.25rem;" src={Traefik} />
...
<img style="float:left; max-width:300px; width:20%;margin-right: 1.5rem; padding: 1.25rem;" src={NGINXSM} />
...
<div style="text-align:center;margin: 2rem;">
  <a href={MesheryAdapterLibrary}><img style=" width:50%;" src={MesheryAdapterLibrary} /></a>
</div>
...
<div class="intro" style="font-size: 1rem; text-align:center;margin: 2rem 4rem;padding:2rem;">Read <Link to="/community/member/michael-gfeller">Maintainer Michael Gfeller</Link>'s blog post <Link to="/blog/meshery/introducing-meshkit-and-the-meshery-adapter-library">Introduction MeshKit and the Meshery Adapter Library</Link> for more details.</div>
