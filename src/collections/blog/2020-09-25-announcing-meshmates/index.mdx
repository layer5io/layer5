...
<BlogWrapper>
  ...
  <br />
  <h4>
    <Link className="invert" to="/community/members/kelechi-nwachukwu">
  ...
  <h4>
    <Link className="invert" to="/community/members/ruth-ikegah"> Ruth Ikegah </Link>
  </h4>
  <img
    src={ Ruth }
    class="image-right"
