...
import architecture from "./meshery-architecture.png";
...
Organizing commnands [under these categories](https://meshery.layer5.io/docs/guides/mesheryctl) is done with both the intention to make `mesheryctl` functions intuitively at your fingertips, but also to make room for forthcoming functionality.
...
<img src={architecture} class="image-right" alt="meshery-architecture" />
...
<center><iframe frameborder="0" width="100%" height="300" allowfullscreen={true} mozallowfullscreen="true" webkitallowfullscreen="true"frameborder="0" width="100%" height="300" allowfullscreen={true} mozallowfullscreen="true" webkitallowfullscreen="true" src="https://www.youtube.com/embed/ds9D2KgZKxo" ></iframe></center>
...
\- [Kush Trivedi](https://www.linkedin.com/in/kushthedude/)
