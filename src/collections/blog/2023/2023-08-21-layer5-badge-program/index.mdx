...
Are you ready to take your open source journey to the next level? We're thrilled to announce an exciting update for all Layer5 users and contributors:  the launch of our improved recognition program! 🎉🎈

Our contributors have always been celebrated at Layer5. Each line of code, each documentation update, and every community interaction contributes to our shared mission of empowering engineers.

Every aspect of what we do revolves around our contributors. We are thrilled to unveil our latest initiative that celebrates and rewards our invaluable users and contributors – [Layer5 Badges](https://badges.layer5.io)!

### What Are Layer5 Badges?

These badges are a representation of your participation and milestones that you achieve together and in solidarity with the Layer5 community. Badges are how users demonstrate their prowess with the projects and how contributors identify their ownership, dedication, skills, and community to Layer5. There are several badges each representing a specific user achievement or contributor skill.
...
Our collection of badges consists of the set that you see posted on this site. New badges are developed on occasion, so keep your eyes peeled for their emergence... or help us design a new one!
