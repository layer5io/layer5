...
<div class="interviewer">
<span>Vivek:</span><p>Now, I’ve heard of Community Badges, but what are these? How many are there? More importantly, how do I collect the whole set?! 🙂</p>
</div>
...
<div class="note"><img src={ForkLift} height="100px" />The open source community at Layer5 is an award winning program and continues to evolve as it grows in number daily. Its projects and activities move at an impressive pace thanks to MeshMates like Yash. Be like Yash. Join the <Link to="/community">Layer5 Community</Link> and say “hi”.</div>
