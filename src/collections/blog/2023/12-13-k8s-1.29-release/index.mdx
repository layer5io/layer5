...
<div class="intro">
  <p>
    As a longstanding CNCF member, Layer5 has donated two of its open source projects to the CNCF: <Link to="/products/meshery">Meshery</Link> and <Link to="/projects/cloud-native-performance">Cloud Native Performance</Link>. As an end-to-end, open-source, multi-cluster Kubernetes management platform, Meshery makes Day 2 Kubernetes cluster management a breeze. Run Meshery to explore the behavorial changes of this Kubernetes release and what they really mean to you. 
  </p>
</div>
...
DZone’s annual trend report on Kubernetes in the Enterprise has 55% of respondents identifying "Maintaining YAML files” as one of the more significant, ongoing pain-points in their experience with Kubernetes. In 2024, I’m looking forward to CNCF projects like Meshery addressing this pain-point with [a visual designer for Kubernetes](/products/meshmap) resource and workflow configuration. The inability for some developers to either be capable of or have time to comprehend the intricacies of their virtualized applications by staring at endless lines of YAML is poised to significantly improve in 2024. 
