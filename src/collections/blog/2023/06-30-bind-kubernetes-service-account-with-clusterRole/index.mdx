...
Refer to the official Meshery <a href="https://docs.meshery.io/installation/quick-start" target="_blank">documentation</a> to install Meshery on your local machine or within your Kubernetes cluster.
...
After successfully connecting Meshery to your Kubernetes cluster, you can access MeshMap from the <a href = "https://playground.meshery.io/" target="_blank">Meshery</a> user interface. MeshMap visually represents the deployed service mesh, including service endpoints, traffic flows, and workload distribution.
