...
- **Efficient Data Plane Design**: Seamlessly design and deploy Istio and Envoy data planes using [Kanvas](https://layer5.io/cloud-native-management/kanvas).
...
### [Kanvas Snapshot](http://localhost:8000/cloud-native-management/gitops)
