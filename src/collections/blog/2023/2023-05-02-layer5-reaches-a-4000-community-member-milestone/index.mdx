...
<p>
  One of the most remarkable things about the Layer5 community is how supportive
  it is of its members. Whether you are a newcomer or a seasoned veteran, you
  will find that people are always willing to lend a hand, offer advice, or just
  provide a friendly ear when you need it.
</p>

<Blockquote
  quote="Thank you for recognising me as a Layer5 member. It is an honour for me to be part of such a welcoming community. Even the smallest contributions are recognised. I am learning new things every day and so happy to belong to this community."
  person="Naureen"
/>
...
<Link to="meshery-surpasses-1000-contributors">
...
As a result of the many, supportive contributors, the Meshery project boasts some
impressive statistics with <Link to="/blog/community/meshery-surpasses-1000-contributors">over 1,000 project contributors</Link>
.
