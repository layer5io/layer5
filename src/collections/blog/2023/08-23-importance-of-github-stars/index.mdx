...
thumbnail_svg: ./hero-image.svg
darkthumbnail_svg: ./hero-image.svg
category: Community
...
<figure className="imgWithCaption">
 ...
 <br/>
<p style="display: flex; justify-content: center;"> This is what a project will look like after you have starred it:
<figure className="imgWithCaption">
    <img src={After}/>
    <figcaption>
    After adding a star
