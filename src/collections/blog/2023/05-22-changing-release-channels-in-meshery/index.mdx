...
<ul>
  <li>Run the following command to see the current configuration for Meshery: <pre><code className="language-bash">mesheryctl system context view</code></pre><img src={MesheryVersion} className="image-center" style={{width: "50%"}} /><p>This will show you the current release channel (<b>stable</b> or <b>edge</b>), along with the version number and other information.</p></li>
