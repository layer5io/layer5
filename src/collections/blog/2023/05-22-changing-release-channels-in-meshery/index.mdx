...
<ul>
  <li>Run the following command to see the current configuration for Meshery: <pre><code class="language-bash">mesheryctl system context view</code></pre><img src={MesheryVersion} className="image-center" style="width:50%;" />This will show you the current release channel (<b>stable</b> or <b>edge</b>), along with the version number and other information.</li>
