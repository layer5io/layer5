...
## I. Introduction
   ...
   The purpose of the blog post is to provide the reader with a sneak peek into an LFX internship and what transitioning to a completely new tech stack can be like.
   Successful completion of my tasks on Meshery during this internship required me to have deep knowledge of Go, Docker, Kubernetes, Helm and a pinch of ReactJs. Three months ago, none of these experiences were part of my repertoire. Now, I want to share my journey of acquiring knowledge through practical involvement and swiftly adjusting to new circumstances.
