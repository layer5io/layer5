...
The tangible results of my contributions were evident. I successfully added the feature to deploy and undeploy Meshery adapters in Docker and Kubernetes environments. Moreover, I upgraded Meshsync, making it configurable and enabling updates on specified resources with specified frequencies. The deprecation of Docker and compose CLIs in favor of Docker and compose Go SDKs streamlined internal command execution. Additionally, I resolved critical bugs, improving the stability and functionality of Meshery. Finally, writing this blog served as another contribution to the project and the Meshery community.
...
## VI. Connect
   ...
   Follow me on [Twitter](https://twitter.com/AzanulZ) & [Github](https://github.com/Azanul), lets connect on [LinkedIn](https://www.linkedin.com/in/azanul-haque/).
   Thanks for investing your time reading the post. I invite you to share your thoughts and experiences in the comments section.
We are always looking for awesome people to join us, there is till a slot open for application [Meshery LFX mentorship](https://mentorship.lfx.linuxfoundation.org/project/0d6fd362-04a1-4086-a6e7-ec753ed4a60b). See you back on [Slack](http://slack.layer5.io/).
