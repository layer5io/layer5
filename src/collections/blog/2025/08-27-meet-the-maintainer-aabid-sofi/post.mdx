...
<div class="interviewer">
  <span>Himani:</span>
  What’s the coolest Meshery UI demo you have done/seen?
</div>
...
<div class="interviewee">
  <span>Aabid:</span>
  Exactly, Himani. It’s all about building momentum. Every small contribution—whether it’s fixing a bug, improving docs, or reviewing a PR—adds up and helps you grow into the role. What matters most is the willingness to learn, adapt, and collaborate with others in the community. That’s the real pathway to becoming a strong contributor and eventually a maintainer.
</div>
