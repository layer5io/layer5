...
thumbnail_svg: ./software-engineer.svg
...
<CareerWrapper>
    ...
    <div className="body-sections">
        ...
        <h3>Responsibilities</h3>
            ...
            internalize Layer5's vision and strategy for helping the world expect more
    ...
    <div className="qualification-section body-sections">
        <Col $xs={12} $lg={6} className="qualification-col">
            ...
            <ul>
                ...
                Cloud Native software design and deployment, Distributed systems concepts is ideal</li>
            </ul>
        </Col>
        <Col $xs={12} $lg={6} className="qualification-col">
