...
thumbnail_svg: ./product-engineering-internship.svg
...
<CareerWrapper>
    ...
    <div className="body-sections">
        ...
        <h3>Responsibilities</h3>
            ...
            internalize Layer5's vision and strategy for helping the world expect more from their infrastructure.
