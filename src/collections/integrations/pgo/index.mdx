...
integrationIcon: icon/color/pgo-color.svg
darkModeIntegrationIcon: icon/white/pgo-white.svg
...
components: 
	-	name: PGUpgrade
		colorIcon: icon/components/PGUpgrade-color.svg
		whiteIcon: icon/components/PGUpgrade-white.svg
		description: 
	-	name: PostgresCluster
		colorIcon: icon/components/PostgresCluster-color.svg
		whiteIcon: icon/components/PostgresCluster-white.svg
		description: 
featureList: [
