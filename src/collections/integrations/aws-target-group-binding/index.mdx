...
workingSlides: [
    ../_images/aws-target-group-designer-dark.png,
    ../_images/aws-target-group-designer-light.png,
    ../_images/aws-target-group-visualizer-dark.png,
    ../_images/aws-target-group-visualizer-light.png]
