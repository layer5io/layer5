...
"colorIcon": "icons/components/cilium-cidr-group/icons/color/cilium-cidr-group-color.svg",
"whiteIcon": "icons/components/cilium-cidr-group/icons/white/cilium-cidr-group-white.svg",
"description": "",
},
{
"name": "cilium-load-balancer-ip-pool",
"colorIcon": "icons/components/cilium-load-balancer-ip-pool/icons/color/cilium-load-balancer-ip-pool-color.svg",
"whiteIcon": "icons/components/cilium-load-balancer-ip-pool/icons/white/cilium-load-balancer-ip-pool-white.svg",
"description": "",
}]
featureList: [
