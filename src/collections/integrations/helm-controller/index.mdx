...
components: 
	-	name: Bucket
		...
		description: 
	-	name: GitRepository
		colorIcon: icon/components/GitRepository-color.svg
		whiteIcon: icon/components/GitRepository-white.svg
		description: 
	-	name: HelmChart
		colorIcon: icon/components/HelmChart-color.svg
		whiteIcon: icon/components/HelmChart-white.svg
		description: 
featureList: [
