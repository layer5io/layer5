...
integrationIcon: icon/color/open service mesh-color.svg
darkModeIntegrationIcon: icon/white/open service mesh-white.svg
docURL: https://docs.meshery.io/service-meshes/adapters/osm
category: Orchestration & Management
subcategory: Service Mesh
featureList: ["Configuration an simplier understanding of your Open Service Mesh deployments and microservices",
