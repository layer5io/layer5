...
"colorIcon": "icons/components/identity-provider-config/icons/color/identity-provider-config-color.svg",
"whiteIcon": "icons/components/identity-provider-config/icons/white/identity-provider-config-white.svg",
"description": "",
}]
featureList: [
