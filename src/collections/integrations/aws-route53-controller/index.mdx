...
components: 
	...
	-	name: AdoptedResource
		...
		description: 
	-	name: HostedZone
		colorIcon: icon/components/HostedZone-color.svg
		whiteIcon: icon/components/HostedZone-white.svg
		description: 
	-	name: RecordSet
		colorIcon: icon/components/RecordSet-color.svg
		whiteIcon: icon/components/RecordSet-white.svg
		description: 
featureList: [
