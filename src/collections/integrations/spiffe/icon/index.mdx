...
integrationIcon: icon/color/spiffe-icon-color.svg
darkModeIntegrationIcon: icon/white/spiffe-icon-white.svg
docURL: 
category: Key Management
featureList: ['Design and apply policy for node and workload attestation.',
