...
components: 
	-	name: PerconaPGBackup
		colorIcon: icon/components/PerconaPGBackup-color.svg
		whiteIcon: icon/components/PerconaPGBackup-white.svg
		description: 
	...
	-	name: PerconaPGRestore
		colorIcon: icon/components/PerconaPGRestore-color.svg
		whiteIcon: icon/components/PerconaPGRestore-white.svg
		description: 
featureList: [
