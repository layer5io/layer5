...
components: 
	...
	-	name: ResolverEndpoint
		colorIcon: icon/components/ResolverEndpoint-color.svg
		whiteIcon: icon/components/ResolverEndpoint-white.svg
		description: 
	-	name: ResolverRule
		colorIcon: icon/components/ResolverRule-color.svg
		whiteIcon: icon/components/ResolverRule-white.svg
		description: 
featureList: [
