...
workingSlides: [
  ../_images/aperture-agent/Aperture-Agent-Design-light.png,
  ../_images/aperture-agent/Aperture-Agent-Design-dark.png,
  ../_images/aperture-agent/Aperture-Agent-Visualize-light.png,
  ../_images/aperture-agent/Aperture-Agent-Visualize-dark.png
]
