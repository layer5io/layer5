...
components: 
	-	name: EnvoyFleet
		colorIcon: icon/components/EnvoyFleet-color.svg
		whiteIcon: icon/components/EnvoyFleet-white.svg
		description: 
	-	name: StaticRoute
		colorIcon: icon/components/StaticRoute-color.svg
		whiteIcon: icon/components/StaticRoute-white.svg
		description: 
	-	name: API
