...
integrationIcon: icon/color/github-actions-runner-operator-color.svg
darkModeIntegrationIcon: icon/white/github-actions-runner-operator-white.svg
...
components: 
	-	name: GithubActionRunner
		colorIcon: icon/components/GithubActionRunner-color.svg
		whiteIcon: icon/components/GithubActionRunner-white.svg
		description: 
featureList: [
