...
integrationIcon: icons/color/azure-red-hat-openshift-color.svg
darkModeIntegrationIcon: icons/white/azure-red-hat-openshift-white.svg
...
---
<p>
Deploys and manages OpenShift clusters on Azure for container-based workloads.
</p>
<p>
