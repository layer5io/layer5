...
integrationIcon: icon/color/jira-service-desk-operator-color.svg
darkModeIntegrationIcon: icon/white/jira-service-desk-operator-white.svg
...
components: 
	-	name: Customer
		colorIcon: icon/components/Customer-color.svg
		whiteIcon: icon/components/Customer-white.svg
		description: 
	-	name: Project
