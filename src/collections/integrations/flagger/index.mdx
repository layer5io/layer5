...
components: 
	-	name: Canary
		colorIcon: icon/components/Canary-color.svg
		whiteIcon: icon/components/Canary-white.svg
		description: 
	-	name: MetricTemplate
		colorIcon: icon/components/MetricTemplate-color.svg
		whiteIcon: icon/components/MetricTemplate-white.svg
		description: 
	-	name: AlertProvider
		colorIcon: icon/components/AlertProvider-color.svg
		whiteIcon: icon/components/AlertProvider-white.svg
		description: 
featureList: [
