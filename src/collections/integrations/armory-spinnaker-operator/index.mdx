...
integrationIcon: icon/color/armory-spinnaker-operator-color.svg
darkModeIntegrationIcon: icon/white/armory-spinnaker-operator-white.svg
...
components: 
	-	name: ArmoryAccount
		colorIcon: icon/components/ArmoryAccount-color.svg
		whiteIcon: icon/components/ArmoryAccount-white.svg
		description: 
	-	name: SpinnakerService
		colorIcon: icon/components/SpinnakerService-color.svg
		whiteIcon: icon/components/SpinnakerService-white.svg
		description: 
featureList: [
