...
featureList: ['Design and apply policy for node and workload attestation.','Configure your signing framework for securely issuing and renewing SVIDs.','Simplify access from identified services to secret stores, databases, services meshes and cloud provider services.']
workingSlides: [
