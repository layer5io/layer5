...
integrationIcon: icon/color/confidential containers-color.svg
darkModeIntegrationIcon: icon/white/confidential containers-white.svg
docURL: 
category: Provisioning
subcategory: Security & Compliance
featureList: ["Allows cloud native application owners to enforce application security requirements.",
