...
integrationIcon: icon/color/aperture-controller-color.svg
darkModeIntegrationIcon: icon/white/aperture-controller-white.svg
...
components: 
	-	name: Controller
		colorIcon: icon/components/Controller-color.svg
		whiteIcon: icon/components/Controller-white.svg
		description: 
	-	name: Policy
