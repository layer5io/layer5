...
featureList: ['SPIRE design and deployment best practices','Configure SPIRE to securely issue and renew SVIDs.','Design workloads to establish trust between each other by establishing an mTLS connection or by signing and verifying a JWT token.']
workingSlides: [
