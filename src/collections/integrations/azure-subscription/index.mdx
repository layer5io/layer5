...
integrationIcon: icons/color/azure-subscription-color.svg
darkModeIntegrationIcon: icons/white/azure-subscription-white.svg
...
---
<p>
Defines access, billing, and governance boundaries for a set of Azure services.
</p>
<p>
