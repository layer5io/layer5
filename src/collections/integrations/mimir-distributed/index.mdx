...
integrationIcon: icon/color/mimir-distributed-color.svg
darkModeIntegrationIcon: icon/white/mimir-distributed-white.svg
docURL: https://docs.meshery.io/functionality/performance-management
category: Observability and Analysis
subcategory: Observability and Analysis
featureList: ["Get 100% Prometheus compatible, including remote write, PromQL, and alerting",
