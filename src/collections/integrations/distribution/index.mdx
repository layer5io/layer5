...
integrationIcon: icon/color/distribution-color.svg
darkModeIntegrationIcon: icon/white/distribution-white.svg
docURL: 
category: Provisioning
subcategory: Container Registry
featureList: ["JFrog Distribution is a centralized platform that lets you provision software release distribution",
