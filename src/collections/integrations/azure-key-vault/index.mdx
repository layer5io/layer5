...
integrationIcon: icons/color/azure-key-vault-color.svg
darkModeIntegrationIcon: icons/white/azure-key-vault-white.svg
...
---
<p>
Safeguards cryptographic keys and secrets in a secure, central cloud repository.
</p>
<p>
