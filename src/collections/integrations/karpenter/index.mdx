...
components: 
	-	name: AWSNodeTemplate
		colorIcon: icon/components/AWSNodeTemplate-color.svg
		whiteIcon: icon/components/AWSNodeTemplate-white.svg
		description: 
	-	name: Provisioner
		colorIcon: icon/components/Provisioner-color.svg
		whiteIcon: icon/components/Provisioner-white.svg
		description: 
featureList: [
