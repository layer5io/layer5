...
integrationIcon: icon/color/mattermost-operator-color.svg
darkModeIntegrationIcon: icon/white/mattermost-operator-white.svg
...
components: 
	-	name: ClusterInstallation
		colorIcon: icon/components/ClusterInstallation-color.svg
		whiteIcon: icon/components/ClusterInstallation-white.svg
		description: 
	-	name: MattermostRestoreDB
		colorIcon: icon/components/MattermostRestoreDB-color.svg
		whiteIcon: icon/components/MattermostRestoreDB-white.svg
		description: 
	-	name: Mattermost
		colorIcon: icon/components/Mattermost-color.svg
		whiteIcon: icon/components/Mattermost-white.svg
		description: 
featureList: [
