...
workingSlides: [
    ./images/meshmap-containerd-updated-dark.png,
    ./images/meshmap-containerd-updated-light.png,
    ./images/meshmap-containerd-views-dark.png,
    ./images/meshmap-containerd-views-light.png,
    ]
