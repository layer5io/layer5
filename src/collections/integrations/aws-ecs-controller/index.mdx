...
darkModeIntegrationIcon: icons/color/aws-ecs-controller-color.svg
...
"colorIcon": "icons/color/aws-ecs-controller-color.svg",
"whiteIcon": "icons/color/aws-ecs-controller-color.svg",
"description": "",
}]
featureList: [
