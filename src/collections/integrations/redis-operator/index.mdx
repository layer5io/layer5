...
{
"name": "redis-failover",
"colorIcon": "icons/components/redis-failover/icons/color/redis-failover-color.svg",
"whiteIcon": "icons/components/redis-failover/icons/white/redis-failover-white.svg",
"description": "",
},
{
"name": "redis-cluster",
