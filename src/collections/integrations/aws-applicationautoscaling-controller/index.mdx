...
components: 
	-	name: AdoptedResource
		...
		description: 
	-	name: ScalableTarget
		colorIcon: icon/components/ScalableTarget-color.svg
		whiteIcon: icon/components/ScalableTarget-white.svg
		description: 
	-	name: FieldExport
		...
		description: 
	-	name: ScalingTarget
		colorIcon: icon/components/ScalingTarget-color.svg
		whiteIcon: icon/components/ScalingTarget-white.svg
		description: 
featureList: [
