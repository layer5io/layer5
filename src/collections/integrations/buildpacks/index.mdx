...
integrationIcon: icon/color/buildpacks-icon-color.svg
darkModeIntegrationIcon: icon/white/buildpacks-icon-white.svg
docURL: 
category: App Definition and Development
subcategory: Application Definition & Image Build
featureList: ["Transform application source code into OCI images.",
