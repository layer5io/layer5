...
integrationIcon: icon/color/fluentd-operator-color.svg
darkModeIntegrationIcon: icon/white/fluentd-operator-white.svg
docURL: https://docs.meshery.io
category: Observability and Analysis
subcategory: Logging
featureList: ["Fluent Operator provides great flexibility in building a logging layer based on Fluent Bit and Fluentd.",
