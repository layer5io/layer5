...
"colorIcon": "icons/components/service-bgp-status/icons/color/service-bgp-status-color.svg",
"whiteIcon": "icons/components/service-bgp-status/icons/white/service-bgp-status-white.svg",
"description": "",
},
{
"name": "service-bgp-status",
