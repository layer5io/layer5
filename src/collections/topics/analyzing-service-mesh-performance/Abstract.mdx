...
import wasmLogo from "./smp-light-text_2.png";
import { TopicsWrapper } from "../Topics.style.js";

<TopicsWrapper>
  <div className="intro">
    <p>Learn more about Service Mesh Performance from this article 
      <Link className="blog" to="https://www.nxtbook.com/nxtbooks/ieee/bridge_issue3_2021/index.php#/p/16">Analyzing Service Mesh Performance</Link> - Published in issue 3 of IEEE Bridge October 2021  </div>
...
necessary or refuses to publish performance data because such tests can be 1) arduous to create and sustain a capable harness, 2) a point-in-time 
consideration (none of the elements under measurement are static, and 3) misinterpreted. 
</p>
...
<p>
Figure 2 provides insight to the fact that the specification defines a common collection of statistical analysis 
...
<p><i>Figure 2: Snippet of the Service Mesh Performance specification describing how to capture statistical analysis of test results.</i></p>
...
<ul>
  ...
  <liL1 and L3 Bound% decreases for both the service cores on which the front –proxy is running as well as the 
