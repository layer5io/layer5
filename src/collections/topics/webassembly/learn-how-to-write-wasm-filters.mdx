...
<TopicsWrapper>
  <div className="intro">
    <p>Learn more about WebAssembly's use within service mesh data planes in
      <Link className="Topics" to="/learn/books">The Enterprise Path to Service Mesh Archictures (2nd Edition)</Link> -  free book and excellent resource for anyone looking to understand WASM filters, Lua scripts, and other options available for extending the data plane.</p>
  </div>
