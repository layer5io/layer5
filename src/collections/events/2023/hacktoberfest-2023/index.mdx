...
<p>
  <Link to="/programs/hacktoberfest">Hacktoberfest</Link> is just around the corner. You'd be
...
<p>
  ...
  Layer5 <Link to="/community/meshmates">MeshMates</Link> and Maintainers. Spend an hour with
