...
type: Event
speakers: ["Gaurav Chadha", "Pranav Singh", "Uzair Shaikh", "Yash Sharma", "Vivek Vishal", "Saurabh Soni", "Antonette Caldwell", "Senali Dilumika", "Sudhanshu Dasgupta", "Rex Joshua"]
published: true
upcoming: true
register: true
---
