...
<p>
  ...
  <a to="https://www.docker.com/products/extensions/">Docker Extensions</a> the easy way with Layer5{" "}
  <Link to="/community/meshmates">MeshMates</Link> and Maintainers. Using the{" "}
  <Link to="/docker-extension-meshery">Docker Meshery Extension</Link>, spend an hour with seasoned,
  open source maintainers and hack your way through. To get a headstart, see our{" "}
  <Link to="/community/newcomers">Newcomers Resources</Link>. Get familiar with the Layer5 community
  through our <Link to="/community/handbook">Community Handbook</Link>.
</p>
...
<p>
  ...
  <ul>
    <li>
      <Link to="https://docs.google.com/spreadsheets/d/11KPLU9vVklgGn9NbluLegbfQAyBA5ZS58AhoA8_PCVI/edit#gid=0">
        Issues for Hacktoberfest
      </Link>
    </li>
    <li>
      <a href="https://www.youtube.com/watch?v=T7xLUqrnxtI">Recorded Livestream</a>
    </li>
    <li>
      <a href={hacktoberfestprepslides}>Presentation Slides</a>
    </li>
  </ul>
</p>
