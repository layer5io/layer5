...
type: Event
speakers: ["Vivek Vishal", "Sudhanshu Dasgupta", "Shlok Mishra", "Hargun Kaur", "Alero Awani"]
published: true
upcoming: true
register: true
---
...
import hacktoberfestBadge from "./layer5-hacktoberfest-badge-large.svg";
...
<ul>
    ...
    <li><a href="https://github.com/issues?q=is%3Aopen+is%3Aissue+archived%3Afalse+org%3Alayer5io+org%3Ameshery+org%3Aservice-mesh-performance+org%3Alayer5labs+org%3Aservice-mesh-patterns+label%3Ahacktoberfest+">Issues for Hacktoberfest</a></li>
