...
<p>
  ...
  developer from Intel <Link to="/community/members/xin-huang">Xin Huang</Link> with the Founder of
  Layer5 <Link to="/community/members/lee-calcote">Lee Calcote</Link> as they discuss SMP project in
...
<p>
  ...
  <Link to="/community/members/lee-calcote">Lee Calcote</Link> as he discusses the many projects of
