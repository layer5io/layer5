...
type: Event
speakers: ["Gaurav Chadha", "Nikhil Ladha", "Sahil Suman", "Anita Ihuman", "Harshit Dandriyal", "Alexis Abakasanga", "Abhishek Kumar", "Ashish Tiwari"]
published: true
upcoming: true
register: true
---
...
<ul>
    ...
    <li><Link to="./hacktoberfest-prep-easing-into-cncf-open-source-projects.pdf">Review the slides</Link></li>
</ul>
</p>