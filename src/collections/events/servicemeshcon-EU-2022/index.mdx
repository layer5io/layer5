...
<h3>
  <a href="https://smp-spec.io/meshmark">MeshMark</a>: Service Mesh Value Measurement
</h3>
<p>
...
<p>
  Read the recap{" "}
  <Link to="/blog/service-mesh-performance/meshmark-cloud-native-value-measurement">blog</Link> post
  and find out more about <a href="https://smp-spec.io/meshmark">MeshMark</a>.
</p>
