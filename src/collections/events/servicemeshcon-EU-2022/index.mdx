...
<p>
Read the recap <Link to="/blog/service-mesh/meshmark-cloud-native-value-measurement">blog</Link> post and find out more about <a href="https://smp-spec.io/meshmark">MeshMark</a>. 
</p>