...
<p>
  Read the recap <Link to="/blog/docker/extending-docker-with-meshery-spire-and-istio">blog</Link>{" "}
  post and find out more about{" "}
  <a href="https://layer5.io/docker-extension-meshery">Docker Extension for Meshery</a>.
</p>
