...
The Meshery extension transforms Docker Desktop into powerful cloud native infrastructure development environment in a box with Kubernetes and service mesh. Learn how to discover and model your cloud native deployments with <Link to="/products/meshmap">MeshMap</Link>. MeshMap enables GitOps integrated, visual composition of your cloud native infrastructure. 
