      ...
      <div className="parentcard">
        ...
        >
          <SectionTitle className="section-title" UniWidth="100%">
            <h3>
              <span>Keep up to date with Layer5. Subscribe.</span>
            </h3>
          </SectionTitle>
          <Row>
            <Col md={3}>
            ...
            <Col md={9}>
              <Row>
                <Col className="nopad" md={1} xs={1}>
                  <MdPermContactCalendar className="contact-icon" size={30}></MdPermContactCalendar>
                </Col>
                <Col md={11} xs={11}>
                  <Row>
                    <Col className="firstcol" md={6} xs={6}>
                      <input
                        className="inputrow"
                        type="text"
                    ...
                    <Col className="lastcol" md={6} xs={6}>
                      <input
                        className="inputrow"
                        type="text"
