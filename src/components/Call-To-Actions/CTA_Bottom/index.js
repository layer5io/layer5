    ...
    <CTA_BottomWrapper {...props}>
      <div className="cta-content">
        ...
        <Button
          primary
          title={
            category ? Categories[category]["Button_Text"] : button_text ? button_text : "Join Us"
          }
          url={category ? Categories[category]["Link"] : url ? url : defaultURL}
          external={category ? Categories[category]["Link_external"] : external_link ? true : false}
        />
      </div>
      <img
        src={category ? Categories[category]["Image"] : image ? image : image_src}
        alt={category ? Categories[category]["Image_Alt"] : alt ? alt : "Alt Text"}
      />
    </CTA_BottomWrapper>
  );
};
