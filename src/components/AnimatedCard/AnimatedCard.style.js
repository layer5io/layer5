...
export const AnimatedCardWrapper = styled.div`
  ...
  /* AWS/Azure/GCP - Using theme colors with proper border contrast */
  &.tag-aws {
  ...
  &.tag-gcp {
    color: ${props => props.theme.whiteToBlue0096d6};
    /* Use a more visible border color for GCP in both themes */
    border: 1px solid ${props => props.theme.whiteToBlue0096d6};
    
    /* Add better contrast for dark mode */
  ...
  /* Cloud/Container Platforms */
  &.tag-kubernetes {
    color: ${props => props.theme.whiteToBlue1229A9};
    border: 1px solid ${props => props.theme.whiteToBlue1229A9};
  ...
  &.tag-openshift {
    color: ${props => props.theme.whiteToRed662839};
    border: 1px solid ${props => props.theme.whiteToRed662839};
  ...
  &.tag-cicd {
    color: ${props => props.theme.whiteToBlue2A2DDE};
    border: 1px solid ${props => props.theme.whiteToBlue2A2DDE};
  ...
  &.tag-golang {
    ...
    border: 1px solid ${props => props.theme.whiteToGreen00D3A9};
  }
  ...
  &.tag-blog {
    ...
    border: 1px solid ${props => props.theme.greyB4B4B4ToGrey505050};
  }
  ...
  &.tag-default {
    ...
    border: 1px solid ${props => props.theme.whiteSixToBlackSix};
  }
  }
