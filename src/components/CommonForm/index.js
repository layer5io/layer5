  ...
  */
  const isValidEmail = (value) => {
    ...
    if (!validEmail) {
      ...
      validEmail &&
      /.*(?=.*@(?:duck\.com|protonmail\.com|anonaddy\.me|tuta\.io)).*/.test(value)
    ) {
      setValidateEmail(true);
      setErrorEmail(
        ...
        <div className="form-body">
          ...
          >
            <Form className="form" method="post">
              ...
              {validateEmail && (
                <p style={{ margin: "0px", color: "red", fontSize: "16px" }}>{errorEmail}</p>
              )}
              <Field
                type="email"
                className="text-field"
           ...
           <p>
            ...
            <div className="accounts_group">
             ...
             <Field type="text" className="text-field" id="linkedin" name="linkedin" placeholder="email" />
              ...
              {validateRole && (
                <p style={{ margin: "0px", color: "red", fontSize: "16px" }}>{errorRole}</p>
              )}
  ...
  return (
    <Container>
      <div className="thank-you-box" ref={ref}>
        ...
        <p>{description}</p>
        <p>
          In the meantime, please visit our <a href="https://discuss.layer5.io">community forum</a>{" "}
          or join us in our <a href="https://slack.layer5.io">community Slack</a>.
        </p>
        <h3 className="white">
