...
const MembersPage = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Layout>
        <GlobalStyle />
        <SEO title="Cloud Native Resources" description="Learn how to provision, secure, connect, and manage your applications on Kubernetes and any service mesh. Service mesh how-tos and cloud native ecosystem news." canonical="https://layer5.io/resources" />
        <Navigation />
