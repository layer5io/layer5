        ...
        <Container>
            ...
            <div style={{ marginBottom: "400px" }}>
                <AnimatedStepsList
                    ...
                    command-line interface to manage your service meshes:{" "}
                                        <code>mesheryctl</code>.
                                    </p>
                                    <p>
                    With <code>mesheryctl</code>, not only you can manage your
                    service meshes, but you can also manage their workloads
                            ...
                            content: (
                                <Terminal
                                    ...
                                    lines={[
                                        ...
                                        {
                                            indent: 1,
                                            code: "SERVER_TOKEN: ${{ secrets.SERVER_TOKEN }}",
                                            color: "white"
                                        },
                                        {
                                            indent: 1,
