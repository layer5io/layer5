  ...
  query allCategories($skip: Int!, $limit: Int!) {
    allCategories: allMdx(
      ...
      filter: {
        ...
        frontmatter: { published: { eq: true }, feature: { ne: false } }
      }
      skip: $skip
      limit: $limit
    ) {
    ...
    allEvents: allMdx(
      filter: {
        frontmatter: { type: { eq: "Event" }, published: { eq: true }, feature: { ne: false } }
      }
    ) {
      nodes {
        id
    ...
    allUpcoming: allMdx(
      filter: {
        frontmatter: { upcoming: { eq: true }, feature: { ne: false } }
        fields: { collection: { eq: "events" } }
      }
      sort: { fields: frontmatter___date, order: DESC }
    ) {
