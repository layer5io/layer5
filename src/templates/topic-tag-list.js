...
export const query = graphql`query TopicsByTags($tag: String!, $skip: Int!, $limit: Int!) {
  allMdx(
    sort: {fields: [frontmatter___date], order: DESC}
    filter: {fields: {collection: {eq: "topics"}}, frontmatter: {tags: {in: [$tag]}, published: {eq: true}}}
    skip: $skip
    limit: $limit
  ) {
    totalCount
