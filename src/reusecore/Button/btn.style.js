...
const ButtonStyle = styled.button` 
    ...
    &:active{
        box-shadow: 0 2px 10px ${props => props.theme.blackToWhiteFive};
    ...
    ${props => props.primary && css`
        ...
        &:hover{
            ...
            box-shadow: 0 2px 10px ${props.theme.whiteToBlackFive};
        }
        &:active{
            background: ${props => props.theme.saffronColor};
            box-shadow: 0 2px 10px ${props.theme.blackToWhiteFive};
            transform: scale(0.98);
        }
