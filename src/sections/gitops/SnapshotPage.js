    ...
    <PageWrapper>
      ...
      <HeroContentContainerWrapper>
        <ContentRow>
          <TextColumn>
            ...
            <Description>
              Verify your workload designs and Kubernetes cluster configurations prior to accepting
      ...
      <ContentContainerWrapper>
        <ContentRow>
          <ColumnContainer>
            <img
              src={GithubActionComment}
              className="screenshot"
              alt="GithubActionComment"
              width={530}
              height={375}
            />
          </ColumnContainer>
          <ColumnContainer>
            <Heading>
              See your deployment <br /> before you merge.
            </Heading>
          </ColumnContainer>
        </ContentRow>
      </ContentContainerWrapper>
