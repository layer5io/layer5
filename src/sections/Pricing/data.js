...
export const details = [
  ...
  { id: 4, category: "Account", description: "Own and control the user accounts of your enterprise members through your identity provider (IdP)" },
...
export const options = [
  {
    ...
    subdata: [
      ...
      { id: 5, category: "Dry-run", description: "", value: <GiCheckMark className="icon" /> },
  ...
  },
  {
    ...
    subdata: [
      ...
      { id: 5, category: "Dry-run", description: "Test and verify configuration changes in a separate environment", value: <GiCheckMark className="icon" /> },
      { id: 6, category: "Feature2", description: "", value: <GiCheckMark className="icon" /> },
      { id: 7, category: "Feature3", description: "", value: <GiCheckMark className="icon" /> },
      { id: 8, category: "Feature4", description: "", value: <GiCheckMark className="icon" /> }]
  },
  {
    ...
    subdata: [
      ...
      { id: 2, category: "Performance", description: "", value: "Automatically suggest optimal resiliency settings for a given service." },
      { id: 3, category: "Management", description: "", value: "Workshop" },
      { id: 4, category: "Account", description: "Own and control the user accounts of your enterprise members through your identity provider (IdP)", value: "Multiple Organizations" },
