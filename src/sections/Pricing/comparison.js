...
.main {
    box-shadow: 0 0 24px ${props => props.theme.whiteToBlackOne};
    margin: 2rem auto;
    display: block;
    overflow-x: scroll;
    overflow-y:hidden;
...
.price-table tr:not(:last-child) {
    border-bottom: 1px solid ${props => props.theme.whiteToBlackOne};
}
.price-table tr td {
    border-left: 1px solid ${props => props.theme.whiteToBlackOne};
    padding: 0rem 2rem;
    font-size: 1rem;
