  ...
  const MemberFormStart = () => {
    return (
      <Container>
        ...
        <p className="para">
          Hi! Welcome to the Layer5 community. As you get oriented with the community and its
          projects, will you consider filling in this form? It helps us get familiarized with you
          and you with the ongoing projects and community. There is much to learn around the
          technologies at-hand. We'll look to get you acclimated and engaged around your areas of
        ...
        >
          <Form className="form" method="post">
            ...
            <Field
              ...
              id="email"
              name="email"
              pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z\s]{2,4}$"
              required
              onInvalid={(e) => e.target.setCustomValidity("Please fill-in this field")}
              onInput={(e) => e.target.setCustomValidity("")}
            />
            ...
            <p className="para label">
              Please provide a link to your profile photo. Profile photos are used for{" "}
              <Link to="/community/members">community member profiles</Link> of longstanding
              community members.
            </p>
            <Button secondary type="submit" className="btn" title="Next Step" /> <br />
            <br />
            <br />
            <br />
          </Form>
      ...
      <Container>
        ...
        <Formik
          initialValues={{
            ...
            interestToShareContribution: MemberFormThirdValue.interestToShareContribution
        ...
        >
          <Form className="form">
            ...
            <label>
              <Field type="checkbox" name="projects" value="Meshery" className="form-check" />
            ...
            <br />
            <label>
              <Field type="checkbox" name="projects" value="NightHawk" className="form-check" />
            ...
            <br />
            <label>
              <Field type="checkbox" name="projects" value="All of them!" className="form-check" />
              <span className="checkbox-label">All of them!</span>
            </label>
            <p className="form-name">
              Mark any of the following 101 tutorials that you would like to receive.
            </p>
            <label>
              <Field
                type="checkbox"
            ...
            <p className="form-name">
              <Link to="https://layer5.io/community/meshmates">Layer5 MeshMates</Link> is a
              community member mentoring program aimed at individuals new to open source or simply
              new to Layer5 projects. Is this program of interest to you?
            </p>
            <label>
              <Field
                type="checkbox"
            ...
            <br />
            <label>
              <Field type="checkbox" name="meshMate" value="Maybe later." className="form-check" />
            ...
            <br />
            <p className="para label">
              If you would like to pair with a MeshMate, please review each MeshMate profile to
              identify your ideal mentor. Once you have identified your ideal MeshMate or if you
              can’t decide on one, simply ask to be partnered in the{" "}
              <a href="https://layer5io.slack.com/archives/C019426UBNY">#newcomers channel</a> in
              the Layer5 Slack.
            </p>
            <label htmlFor="interests" className="form-name">
              What has your recent focus been? Why have you joined the community? What are you
              passionate about? Is there a specific project or aspect of project that interests you?
            ...
            <label htmlFor="profiency" className="form-name">
              If a contributor, what tools, technologies, or languages are you most proficient with?
            </label>
            <Field as="textarea" className="text-field" id="profiency" name="profiency" />
            <p className="para label">
              Examples: [Go/Gorilla, Javascript/React… ], [Photoshop, Illustrator, Figma…], [DevOps,
              Kubernetes, AWS, CI pipelining…], [Digital marketing, social media, community
              management…]
            </p>
            ...
            <br />
            <label>
              <Field type="checkbox" name="areaOfFocus" value="DevOps" className="form-check" />
              <span className="checkbox-label">DevOps</span>
            </label>
            <br />
            <label>
              <Field type="checkbox" name="areaOfFocus" value="User" className="form-check" />
              <span className="checkbox-label">User</span>
            </label>
            <br />
            <label>
              <Field type="checkbox" name="areaOfFocus" value="Other" className="form-check" />
              <span className="checkbox-label">Other</span>
            </label>

            <label htmlFor="interestToShareContribution" className="form-name">
              Now or eventually, would you like to speak or write about your works in the community
              and/or on the projects?<span className="required-sign">*</span>
            </label>
            <div role="group" aria-labelledby="my-radio-group">
              <label>
  ...
  const MemberFormFour = () => {
    return (
      <Container>
        ...
        <p>
          Commonly asked questions about general engagement expectations and information focal to
          internship programs. See the <Link to="/community">Layer5 Community</Link> and{" "}
          <Link to="/programs">Open Source Internship Programs</Link> for additional information.
        </p>
        <Formik
          initialValues={{
            expect: false,
        ...
        >
          <Form className="form">
            ...
            <p className="para label">
              The Layer5 community expects you to get as much or more out of your time than you give
              to the projects. We expect earnest effort from its contributors. What “earnest effort”
              means is different for each community member as all have different circumstances.
              Suffice to say, the more you put into your efforts, the greater your reward will be.
              Most community contributors stay with the project for many months, if not
              indefinitely. Length of involvement is entirely up to the individual community member.
            </p>
            <label>
            ...
            <p className="form-name">
              I see works of other contributors being highlighted in the Layer5, Meshery, and SMP
              Twitter feeds, the Meshery and SMP showcases, and in the Layer5 YouTube channel.
            </p>
            <p className="para label">
              We try to elevate the works of our contributors. All of our community members are
              proud of their work and so are we! We want their work and names to be recognized
              across our collective technology industry. Be sure to follow and engage with these
              Twitter accounts, YouTube, and LinkedIn accounts.
            </p>
            <label>
              <Field type="checkbox" name="highlighted" className="form-check" />
              <span>Ok</span>
            </label>
            <p className="form-name">
              Are community contributors paid? Are internships paid? What do I get in return?
            </p>
            <p className="para label">
              With few exceptions, generally community contributors and interns are not paid. Those
              that participate through Google Summer of Code, LFX, or Google Season of Docs do
              receive a stipend at the culmination of their internship. The largest return on time
              invested in the community for any contributor is the knowledge, relationships,
              recognition, and experience gained throughout their engagement. Their participation
              affords them an opportunity to work with world-class engineers, gives focus and
              purpose to their learning efforts on technologies they otherwise may not understand,
              and exposes their work broadly to the Cloud Native community. Letters of
              recommendation, mentorship and coaching, introduction to engineers at
              globally-recognized technology companies, potential contract or full-time work at
              Layer5, public writing and speaking opportunities are all examples of benefits those
              that participate can receive for their time spent.
            </p>
            <label>
            ...
            <p className="form-name">
              I see other contributors have affiliated themselves with Layer5 on LinkedIn. Am I
              encouraged to do the same?
            </p>
            <p className="para label">
              Yes! We welcome you to affiliate with the community and projects. We consider this
              affiliation helpful in boosting your profile and resume in context of job searches and
              overall in general. Be sure to update your profile, and be social about your
              activities. We love to highlight our members!
            </p>
            <label>
            ...
            <p className="form-name">
              Is there anything else we should know about you? How can we help you?
            </p>
