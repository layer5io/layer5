      ...
      <div className="community-section-wrapper">
        <Container>
          <Row className="service-mesh-projects">
            <Col sm={12} lg={6}>
              <h2>
                Largest collection of service mesh projects and their
                maintainers in the world
              </h2>
              <p>
                We build projects to provide learning environments, deployment
                and operational best practices, performance benchmarks, create
                documentation, share networking opportunities, and more. Our
                shared commitment to the open source spirit pushes Layer5
                projects forward.
              </p>
            </Col>
            <Col sm={12} lg={6}>
          ...
          <Row className="our-community-members_row">
            <Col className="community" sm={12} lg={6}>
              ...
              <p>
                ...
                encourage to embrace these values and support one another in
                meaninfully and consistently advancing the community's open
                source initiatives.
              </p>
              <p>
            ...
            <Col xs={12} lg={6} className="text">
              <div>
                ...
                <p className="invitation">
                  ...
                  <a href="community/newcomers">Contributor's Journey Map</a>
