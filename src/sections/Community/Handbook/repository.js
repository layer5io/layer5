      ...
      <div className="page-section">
        <Container>
          <div className="content">
            ...
            <p>
              A brief introduction to all of the Github repositories of Layer5 organization is
              offered below. This overview serves as a resource to newcomers seeking a perspective
              of the collective community efforts (from a code-centric perspective). See{" "}
            ...
            <p>
              Note that the Layer5 community spans <strong>five</strong> GitHub organizations:
            </p>
            ...
            <ul className="project-org-list">
              ...
              <li>
                ...
                <img src={MeshMap} alt="MeshMap logo" style={{ height: "1.5rem" }} /> MeshMap.
              </li>
            </ul>
                    ...
                    {backendProject.subdata.map((subdata) => {
                      ...
                      return (
                        <tbody key={project}>
                          <tr>
                            <td>
                              <img className={siteIconClasses} src={image} alt="project" />
                              &nbsp;{project}{" "}
                            </td>
                            <td>{language}</td>
                            <td>{description}</td>
