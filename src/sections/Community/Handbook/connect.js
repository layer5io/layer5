      ...
      <div className="page-section">
        <Container>
          <div className="content">
            ...
            <p>
              Don’t miss out on anything, sign up to receive updates on our newest releases, latest
              blog posts and any relevant information.
            </p>
            <ul>
              <li>
              ...
              <li>
                <a href="https://smp-spec.io/subscribe">Service Mesh Performance mailing list</a>
              </li>
            </ul>
            <a id="Mailing Lists">
              {" "}
            ...
            <ul>
              ...
              <li>
                <a href="mailto:community@smp-spec.io">Service Mesh Performance Community</a>
              </li>
              <li>
                <a href="mailto:maintainers@smp-spec.io">Service Mesh Performance Maintainers</a>
              </li>
              <li>
                <a href="mailto:user-group@smp-spec.io">Service Mesh Performance Users</a>
              </li>
              <li>
            ...
            <p>
              Don’t miss out on any of the activities in the community. Join any or all of the
              weekly meetings subscribing to the{" "}
              <a href="https://layer5.io/community/calendar#meetings">community calendar .</a>
            </p>{" "}
            <a id="Slack Community">
              {" "}
              <h2>Slack Community</h2>{" "}
            </a>
            <p>We are a community of like-minded people with thousands of members.</p>
            <p>
              Join our <a href="https://slack.layer5.io/">Slack Workspace</a> introduce yourself and
              interact with the community. There are different channels in the workspace to engage
              within.
            </p>
            <div className="channels-list">
              <p>
                <a href="https://layer5io.slack.com/archives/CDM0ACDM5">#general</a> - For
                workspace-wide communication and announcements.
              </p>
              <p>
                <a href="https://layer5io.slack.com/archives/CFGG6U10E">#meshery</a> - For
                discussion on topics in and around Meshery.
              </p>
              <p>
                <a href="https://layer5io.slack.com/archives/C017NA80S66">#meshery-adapters</a> -
                Discuss topics related to meshery-adapters.
              </p>
              <p>
                <a href="https://layer5io.slack.com/archives/C011VPREG2Z">#meshery-ci</a> - For
                discussion on topics related to Meshery Build, Release, Workflows, DevOps.
              </p>
              <p>
                <a href="https://layer5io.slack.com/archives/C010LFFGFFA">#meshery-meshsync</a> -
                For discussions on issues related to MeshSync.
              </p>
              <p>
                <a href="https://layer5io.slack.com/archives/C0130BQ4L3T">#mesheryctl</a> - For
                discussions on Meshery’s CLI
              </p>
              <p>
                <a href="https://layer5io.slack.com/archives/C019426UBNY">#newcomers</a> - For
                welcoming first-time contributors and community newcomers.
              </p>
              <p>
                <a href="https://layer5io.slack.com/archives/CVBGPTFJN">#performance</a> - For
                discussions related to measuring and evaluating cloud native performance.
              </p>
              <p>
                <a href="https://layer5io.slack.com/archives/C012UMS2MCM">#wasm</a> - For
                discussions on webassembly, rust, envoy filters.
              </p>
              <p>
                <a href="https://layer5io.slack.com/archives/C015QJKUMPU">#websites</a> - For
                discussions related to the UI/UX of <a href="http://layer5.io/">Layer 5</a> project
                sites.
              </p>
            </div>
            ...
            <p>
              ...
              that create them. Learn more about Layer5 and connect with the community by following
              and engaging with us on our social media accounts.
            </p>
            <div>
