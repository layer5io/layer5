      ...
      <div className="page-section">
        <Container>
          <div className="content">
            <a id="General contribution flow">
            ...
            <div className="content">
              ...
              <ul>
                ...
                <li>
                  <span>
                    ...
                    on the code button and then click the “copy to clipboard”
                    icon if you intend to use a command-line tool.{" "}
                  </span>
                </li>
                <li>
                  <span>
              ...
              <ul>
                <li>
                  <span>
                    ...
                    fix, you'll want to make sure you keep your fork up to date
                    by tracking the original "upstream" repo that you forked
                    earlier.
                  </span>
                </li>
                <li>
              ...
              <ul>
                <li>
                  <span>
                    ...
                    proper git workflow, but it also keeps your changes
                    organized and separated from the master branch so that you
                    can easily submit and manage multiple pull requests for
              ...
              <p>
                ...
                Certificate of Origin (DCO) for each commit you make. The DCO is
                a simple statement that you, as a contributor, have the legal
                right to contribute.{" "}
              </p>
              <p>
                To signify that you agree to the DCO for contributions, you
                simply add a line to each of your git commit messages:
              </p>
              <div className="codes">
              ...
              <p>
                ...
                pseudonyms or anonymous contributions). An example of signing
                off on a commit:
              </p>
              <div className="codes">
              ...
              <p>
                To ensure all your commits are signed, you may choose to add
                this alias to your global .gitconfig:
              </p>
              <div className="codes">
                <Code
                  codeString="[alias]
...
"
              ...
              <p>
                Or you may configure your IDE, for example, Visual Studio Code
                to automatically sign-off commits for you:
              </p>
              ...
              <ul>
                <li>
                  <span>
                    Head over to your forked repository on GitHub and you'll see
                    a Compare & pull request button. Click on that button.
                  </span>
                  <br />
                  <span>
                    Note: Please ensure that the right branch is selected for
                    the PR.
                  </span>
                  <div>
                    <br />
              ...
              <ul>
                <li>
                  <span>
                    ...
                    your pull request that explains your contribution. Once
                    you're done, click on the Create pull request button.
                  </span>
                  <div>
                    <br />
