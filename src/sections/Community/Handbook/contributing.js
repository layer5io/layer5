        ...
        <Container>
          ...
          <div className="content">
            ...
            <ul>
              ...
              <div class="codes"><Code codeString="git clone “URL you copied from the clipboard.”" /></div></span></li>
            </ul>
            ...
            <ul><li><span>Keeping your fork up to date while this isn't a necessary step. If you plan on doing anything more than a tiny quick fix, you'll want to make sure you keep your fork up to date by tracking the original "upstream" repo that you forked earlier.</span></li>
              <li><span>To do this, you'll need to add a remote. An example of the command is given below:
                <div class="codes"><Code codeString="git remote add upstream https://github.com/layer5io/meshery.git " /></div>
            ...
            <ul>
              ...
              <li><span>Perform the flow:
                <div class="codes"><Code codeString=" git checkout -b your-new-branch-name" /></div>
             For example,<div class="codes"><Code codeString="git checkout -b feature"/></div>  (feature being a branch name)</span></li>
            </ul>
            ...
            <ul>
              ...
              <div class="codes"><Code codeString="git add <file> " /></div></span></li>
              <li><span> If you add multiple file changes to the branch, you simply use:
              <div class="codes"><Code codeString=" git add ." /></div></span></li>
            </ul>

            <h3>Commit the changes made</h3>
            <ul>
              <li><span>Now commit those changes using the git commit command:
                <div class="codes"><Code codeString="git commit -s -m “This is my commit message”" /></div></span></li>
            </ul>

            <h3>Push changes to Github and submit a pull request (PR)</h3>
            <ul>
              <li><span>To push your changes, run the git command:
                <div class="codes"><Code codeString="git push origin your_branch_name" /></div></span></li>
            </ul>
