...
import CGB from "./images/community-green.svg";
import PL from "./images/patterns-logo.png";
import LG from "./images/landscape-green.png";
import LIH from "./images/layer5-image-hub.svg";
import MLL from "./images/meshery-logo-light.svg";
import MOD from "./images/meshery-operator-dark.svg";
import SDT from "./images/smp-dark-text.svg";
import GNL from "./images/getnighthawk-logo.png";
      ...
      <div className="page-section">
        <Container>
          <div className="content">
            ...
            <ul>
              <li><img src={CGB} style={badgeStyle}/>Community</li>
              <li><img src={LG} style={badgeStyle}/>Landscape</li>
              <li><img src={LIH} style={badgeStyle}/>Image Hub</li>
              <li><img src={MLL} style={badgeStyle}/>Meshery</li>
              <li><img src={MOD} style={badgeStyle}/>Meshery Operator</li>
              <li><img src={SDT} style={badgeStyle}/>Service Mesh Performance</li>
              <li><img src={GNL} style={badgeStyle}/>GetNighthawk</li>
              <li><img src={PL} style={badgeStyle}/>Patterns</li>
            </ul>
