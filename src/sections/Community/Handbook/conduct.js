      ...
      <div className="page-section">
        <Container>
          <div className="content">
            ...
            <ul>
              <p><StaticImage className="logo" src={Point} />The use of sexualized language or imagery</p>
              <p><StaticImage className="logo" src={Point} />Personal attacks</p>
              <p><StaticImage className="logo" src={Point} />Trolling or insulting/derogatory comments</p>
              <p><StaticImage className="logo" src={Point} />Public or private harassment</p>
              <p><StaticImage className="logo" src={Point} />Publishing other’s private information, such as physical or electronic addresses, without explicit permission</p>
              <p><StaticImage className="logo" src={Point} />Other unethical or unprofessional conduct</p>
            </ul>
