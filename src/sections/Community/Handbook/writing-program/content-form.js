          ...
          >
            <Form className="form" method="post">
              ...
              <label htmlFor="slackName" className="form-name">
                If yes, please mention your username on Slack. If no, you are welcome to join -
              ...
              <label id="content-type" className="form-name">
                Choose the type of content<span className="required-sign">*</span>
              </label>
              {validateContent && (
                <p className="validation">Please provide your choice of content.</p>
              )}
...
const ThankYou = () => {
  return (
    <div className="thank-you-box">
      ...
      <p>
        You will soon receive detailed guidance from our content team. We'll get back to you as soon
        as we can.
      </p>
      <p>
        In the meantime, please visit our <a href="https://discuss.layer5.io">community forum</a> or
        join us in our <a href="https://slack.layer5.io">community Slack</a>.
      </p>
      <h3 className="white">
