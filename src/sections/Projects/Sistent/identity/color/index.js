      ...
      <div className="content">
        ...
        <div className="main-content">
          <p>
            ...
            detailed explanation of color application along with practical use cases is needed. To
            this end, the following concepts help to shape a suitable identity as we aim for balance
          ...
          <p>
            When the color palette is accurately put to use, it ensures a recognizable consistency
            in Layer5's array of digital interfaces and products. This is made possible due to
            adherence to well defined rules which though specific, are also flexible and give ample
            room for professionals to curate appealing solutions across themes.
          </p>
          <a id="The Basics">
            <h2>The Basics</h2>
          </a>
          <p>
            ...
            understanding what they mean will inform us of applicable use cases and proper
            procedures that should not be overlooked.
          </p>
          <h3>Theme</h3>
          <p>
            ...
            and layout patterns. Currently, sistent outlines specifications for light and dark
            themes.
          </p>
          <h3>Value</h3>
          <p>
            A value is the unique visual attribute assigned to a token through the use of themes.
            This could range from hex codes to rgba values which are used to highlight specific
            colors in any given instance. We highly recommend that no exact values be referenced
            anywhere in the design in order to avoid errors and ensure consistency. Instead, tokens
            should be used to curate and implement the reusable values. More on tokens next.
          </p>
          <h3>Tokens</h3>
          <p>
            ...
            warning, brand, inverse), and modifier(s) (secondary, tertiary, hover) in a string of
            text that will represent set values gotten from the colors in the color palette.
          </p>
          <h3>Role</h3>
          <p>
            ...
            different use cases. These values can be different though depending on the current
            theme.
          </p>
          <a id="Color Anatomy">
            <h2>Color Anatomy</h2>
          ...
          <p>
            Sistent's default themes are derived from Layer5's color palette of which the Keppel
            Green color serves as the dominant primary action color with subtle shifts in value to
            enable the required visual accessibility as recommended in the WCAG (Web Content
            Accessibility Guidelines) 2.1 compliance standards. It is also sometimes combined with
            Saffron Yellow and Caribbean Green colors accentuate some other parts of the user
          ...
          <Row Hcenter className="image-container">
            <Col md={8} lg={8} sm={12}>
              <img src={isDark ? TonalPalleteDark : TonalPallete} alt="Tonal Palette" />
            </Col>
          </Row>
          <a id="Layer Hirarchy">
          ...
          <p>
            For backgrounds and surfaces, colors in the neutral palettes are used cohesively to
            create depth and spatial associations. This hierarchical pattern defines the logic of
            how colors stack on top of each other in a UI when implementing Sistent themes. This
            logical pattern goes beyond just themes but is also built across components and
            accounted for in suggested color tokens as well.
          </p>
          <p>
          ...
          <p>
            ...
            for distinguishable text and color.{" "}
            <strong>
            ...
            and guidelines are kept at the core of the color selection process.There is further
            specification on how to maintain compliance with these standards in both light and dark
            themes:
          </p>
          <h3>Light Theme</h3>
          <p>
          ...
          <h3>Dark Theme</h3>
          <p>
            For the dark theme, the Keppel Green meets the contrast requirement easily and as such
            can be used as the primary accent color for all necessary use cases.
          </p>
          <Row Hcenter className="image-container">
            <Col md={8} lg={8} sm={12}>
