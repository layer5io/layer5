...
const SMIWrapper = styled.section`
    ...
    .feature-block{
        ...
        border-radius: 20px;
        box-shadow: 0 0 ${props => props.theme.projectPageShadowsize} 5px ${props => props.theme.greenBrightToGreyTint};
        position: relative;
        ...
        height: 100%;
        &:hover{
            border-color: ${props => props.theme.greenBrightToGreyTint};
            .thumb-block{
