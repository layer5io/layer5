        ...
        <div className="freeCont">
          <div className="product_hero">
            <div className="product_hero_text">
              ...
              <p>
                Unlock your enterprise's capabilities with our innovative cloud native solutions.
                Crafted to tackle cloud challenges, our offerings enhance processes for
                effectiveness, scalability, and flexibility, elevating operations to new
                efficiencies.{" "}
              </p>
              <div className="btn">
                <Button
                ...
                <>
                  <div className="card" key={card.id}>
                    ...
                    <div className="card_bottom">
                      ...
                      <a className="learn" href={card.url}>
                        Learn more
                      </a>
                      {/* </Link> */}
          ...
          <div className="freeTry">
            ...
            <div className="headers rotate gap">
              ...
              <p className="paraInfo">
                Embrace the future of technology and embark on a transformative journey with our
                comprehensive range of products prepared to meet your needs. Elevate, Innovate, and
                conquer the cloud with us today!
              </p>
              <Button
                button
                secondary
          ...
          <div className="headers bot_gap">
            ...
            <p className="paraInfo">
              Choose the ideal plan to propel your infrastructure goals. From startups to seasoned
              enterprises, we have a plan designed to fit your unique needs.
            </p>
          </div>
          ...
          <div className="headers gap">
            ...
            <div className="paras">
              ...
              <p className="paraInfo">
                Book to see it in action! Our experts are eager to guide you through the incredible
                possibilities that Layer5 offers. Take this opportunity to discover what more your
