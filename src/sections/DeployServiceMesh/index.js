        ...
        <Container>
          <Row>
            ...
            <Col sm={12} md={6} lg={4}>
              <h4>it depends...</h4>
              <p>
                At this point, you might be thinking, “I have a container orchestrator. Why do I
                need another infrastructure layer?”{" "}
              </p>
            </Col>
            <Col sm={12} md={6} lg={4}>
              <h4>Service-level needs</h4>
              <p>
                With microservices and containers mainstreaming, container orchestrators provide
                much of what the cluster (nodes and containers) need.
              </p>
            </Col>
          </Row>
        ...
        <Container>
          <Row>
            ...
            <Col sm={12} md={6} lg={4}>
              ...
              <p>
                The higher volume of service requests that you have to internal and external
                services there are, the more insight and control you will need and the higher the
                return on investment your service mesh will deliver.
              </p>
            </Col>
            <Col sm={12} md={6} lg={4}>
              <h4>Observability</h4>
              <p>
                Edge focus—metrics and usage are for response time to clients and request failure
                rates.
              </p>
            </Col>
          </Row>
