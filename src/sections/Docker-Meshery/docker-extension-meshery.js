          ...
          <Col md={6} sm={12}>
            ...
            <Row className="extension-feature mobile-image-reverse">
              <Col lg={10}>
                ...
                <i>
                Using <Link to="/products/meshmap">MeshMap</Link> as a visual topology for designing Docker Compose applications, operating Kubernetes, service meshes, and their workloads.
                </i>
              </Col>
              <Col className="docker-extension-meshery" lg={2}>
                <StaticImage
