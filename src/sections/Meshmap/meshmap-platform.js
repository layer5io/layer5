...
const Platform = () => {
  return (
    <PlatformWrapper>
      ...
      <p className="caption">Get MeshMap where you need it.</p>
          ...
          features={[
            {
              ...
              content: <img src={SelfHosted} alt="MeshMap Self-hosted" className="modes-image" />
            },
            {
              title: "Cloud",
              description:
              ...
              content: <img src={CloudHosted} alt="MeshMap Cloud" className="modes-image" />
            }
          ]}
        />
      </div>
      ...
      <div className="blocks">
        <div className="block block--left">
          ...
          <p>
            Keep your MeshMap designs internal to your workplace. Get remote support from Layer5
            when you need it.
          </p>
        </div>
        <div className="block block--right">
          ...
          <p>
            Connect to Layer5 Cloud and have your MeshMap designs versioned and available for team
