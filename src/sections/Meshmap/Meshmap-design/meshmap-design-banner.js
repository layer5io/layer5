...
const DesignBannerWrapper = styled.div`
  ...
  /* .banner-image {
        ...
        .banner-image-colorMode_svg__colorMode2 {
            ...
            offset: ${(props) =>
    props.theme.blue477E96ToGreen00B39F === "#477E96" ? 0.510971 : 0.210971};
            transition: 0.8s cubic-bezier(0.2, 0.8, 0.2, 1);
        }
  ...
  return (
    <DesignBannerWrapper>
      ...
      <div className="hero-text">
        ...
        <h2>Designer</h2>
        <p>
          Drag-and-drop your cloud native infrastructure using a palette of thousands of versioned
          Kubernetes components. Using GitOps? Integrate visual reviews into your pipeline.
        </p>
      </div>
      <div className="hero-image">
        ...
        <Button
          secondary
          title="Experience context-aware design"
