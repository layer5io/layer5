        ...
        <div className="project__block__wrap">
            ...
            >
              <div className="feature-image">
                ...
                <img
                  ...
                  alt=""
                  className={
                    hoveredFeature == "Feature1" ? "secondary-image-visible" : "secondary-image"
                  }
                />
              </div>
            ...
            >
              <div className="feature-image">
                ...
                <img
                  ...
                  alt=""
                  className={
                    hoveredFeature == "Feature2" ? "secondary-image-visible" : "secondary-image"
                  }
                />
              </div>
              <h3>Real-time performance metrics</h3>
              <p>
                Monitor your clusters performing in action, set alerts and work with object-specific
                metrics.
              </p>
            </div>
          </Col>
            ...
            >
              <div className="feature-image">
                ...
                <img
                  ...
                  alt=""
                  className={
                    hoveredFeature == "Feature3" ? "secondary-image-visible" : "secondary-image"
                  }
            ...
            >
              <div className="feature-image">
                ...
                <img
                  ...
                  alt=""
                  className={
                    hoveredFeature == "Feature4" ? "secondary-image-visible" : "secondary-image"
                  }
                  style={{ width: "80%" }}
                />
              </div>
              <h3>Timeline (DVR)</h3>
              <p>
                Playback service transactions. Scrub over the history of changes to your
                deployments.
              </p>
            </div>
          </Col>
          <Col sm={12} md={6} lg={4}>
            ...
            >
              <div className="feature-image">
                <img
                  src={isDark ? ServicePerformanceGearDark : ServicePerformanceGearLight}
                  alt="Service Performance"
                  style={{ position: "absolute", zIndex: "0" }}
                />
                <ServicePerformanceMeter
                  alt=""
                  className={hoveredFeature == "Feature5" ? "meter-visible" : "secondary-image"}
                  style={{
                    height: "auto",
                    width: "70%",
                    position: "relative",
            ...
            >
              <div className="feature-image">
                ...
                <img
                  ...
                  alt=""
                  className={
                    hoveredFeature == "Feature6" ? "secondary-image-visible" : "secondary-image"
                  }
                />
              </div>
              <h3>Log Stream</h3>
              <p>
                Stream and filter through the logs using keywords for multiple Kubernetes Pods
                simultaneously.
              </p>
            </div>
          </Col>
