    ...
    return (
      <Container>
        <div className="black-box">
          <h2>Thank you for your interest in MeshMap.</h2>
          <p>Please patiently await your acceptance into and start of  the beta program. You are now signed up for the Layer5 MeshMap beta program and your position on the waiting list is confirmed. We are working through a growing waitlist. <br />
If you have any questions in the meantime, please email meshmap@layer5.io.<br />
Regards,<br />
