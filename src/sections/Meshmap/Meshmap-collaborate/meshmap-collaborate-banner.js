    ...
    <CollaborationBannerWrapper>
      <div className="banner">
        <div className="banner-text">
          ...
          <h4>
            Designer and Visualizer live side-by-side, so all design work, from ideation to
            operation, can be found in one place.
          </h4>
          <Button
            primary
        ...
        <div className="transition-container" ref={transitionRef}>
          ...
          <div>
            <IngressGatewayImage
              className={
                imageInView ? "ingress-gateway-transition ingress-gateway" : "ingress-gateway"
              }
          ...
          <img
            className={
              imageInView ? "supporting-arrows-transition supporting-arrows" : "supporting-arrows"
            }
