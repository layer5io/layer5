...
const DesignerFeaturesDiagram = ({ activeExampleIndex }) => {
  ...
  return (
    <DiagramStyles>
      <div className="root">
        <img id="design-image1" ref={ref} className={inView ? "show" : "render"} src={roleBind1} alt="" />
        <img id="design-image2" className={(activeExampleIndex >= 1) ? "show" : "render"} src={roleBind2} alt="" />
        <img id="design-image2" className={(activeExampleIndex >= 2) ? "show" : "render"} src={roleBind3} alt="" />
        <img id="design-image2" className={(activeExampleIndex >= 3) ? "show" : "render"} src={roleBind4} alt="" />
      </div>
    </DiagramStyles>
  );
};
