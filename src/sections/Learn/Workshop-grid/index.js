              ...
              {data.allMdx.nodes.map(({ id, frontmatter, fields, body }) => (
                ...
                >
                  <div className="workshop-grid-card">
                    ...
                    <div
                      className={content && ID === id ? "btn-and-status-open" : "btn-and-status"}
                    >
                      <div className="social-icons">
                        {frontmatter.slack &&
                        frontmatter.status === "delivered" &&
                        content &&
                        ID === id ? (
                          <a
                            href={frontmatter.slack}
                            target="_blank"
                            rel="noreferrer"
                            className="links"
                          >
                      ...
                      <div
                        className={
                          content && ID === id ? "linkAndReadBtns-open" : "linkAndReadBtns"
                        }
                      >
                        <div className="expand">
                          {content && ID === id ? (
                            <button onClick={() => toggleActive(id)} className="readmeBtn">
                              {" "}
