  ...
  return (
    <LearnPageWrapper>
      <div className="page-header-section">
        ...
        <h3>
          Free training and how-tos on cloud native architectures, deployment models with
          Kubernetes, Istio, Prometheus, Open Policy Agent, Jaeger, Terraform, Linkerd, Consul...
        </h3>
      </div>
      <BooksSection />
      <WorkshopsSection />
