...
export const query = graphql`query eachCourse($course: String!) {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Layout>
        ...
        <Navigation />
        <CourseWrapper>
          <CourseOverview course={courseData.data.courseByTitle.nodes[0]} chapters={courseData.data.courseChapters.nodes} /> 
        </CourseWrapper>
        <Footer />
      </Layout>
    </ThemeProvider>
