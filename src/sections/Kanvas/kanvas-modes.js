      ...
      {/* <section className="modes-wrapper flip">
        <div className="mode-catalog">
          ...
          <div className="content">
            ...
            <p>Create and share your own Kubernetes deployments and <Link to="/learn/service-mesh-books/service-mesh-patterns">service mesh patterns</Link> in KanvasDesigner or import from the catalog. </p>
          </div>
        </div>
      </section> */}
    </KanvasModesWrapper>
