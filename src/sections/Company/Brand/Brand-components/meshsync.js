    ...
    <MeshSyncWrapper>
      <div className="post-content">
        <Row className="sub-project brand-section">
          ...
          <Col>
            <p>
              The MeshSync mark includes the MeshSync name & logo, and any word, phrase, image, or
        ...
        <Row>
          ...
          <Col>
            <p>
              The MeshSync color palette consists of the primary MeshSync color and additional
              shades. The MeshSync logo should be white or monochrome tonal when using a color
              background.
            </p>
          </Col>
