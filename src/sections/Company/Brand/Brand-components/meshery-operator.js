    ...
    <MesheryOperatorWrapper>
      <div className="post-content">
        <Row className="sub-project brand-section">
          ...
          <Col>
            <p>
              ...
              suggesting sponsorship or endorsement by Layer5, or in a way that confuses Layer5 with
        ...
        <Row>
          ...
          <Col>
            <p>
              The Meshery Operator color palette consists of the primary Meshery Operator color and
              additional shades. The Meshery Operator logo should be white or monochrome tonal when
