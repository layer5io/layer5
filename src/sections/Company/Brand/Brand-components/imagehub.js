  ...
  return (
    <div className="post-content">
      <Row className="brand-section">
        ...
        <Col>
          <p>
            The Image Hub mark includes the Image Hub name & logo, and any word, phrase, image, or
      ...
      <Row>
        ...
        <Col>
          <p>
            The Image Hub color palette consists of the primary Image Hub color and additional
            shades. The Image Hub logo should be white or monochrome tonal when using a color
            background.
          </p>
        </Col>
