      ...
      <Container>
        <Row className="heading">
          <Col>
            ...
            <h4>
              Dedicated to empowering you to expect more from your
              infrastructure.
            </h4>
          </Col>
        </Row>
        <Row Vcenter>
          ...
          <Col xs={12} sm={6} lg={6}>
            ...
            <p className="quote">
              "Diverse microservices patterns and technologies, together with
              the requirements of given microservice applications,provide myriad
              opportunities for service mesh differentiation and specialization
              - including meshes native to specific cloud platforms. This will
              lead to a world where many enterprises use multiple service mesh
              products, whether separately or together."
            </p>
            <Button
              className="book_btn"
              primary
