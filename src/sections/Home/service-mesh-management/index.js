  ...
  return (
    <MeshSectionWrapper>
      <Container fullWidthSM>
        <Row>
          <SectionTitle className="section-title" leftAlign={false} UniWidth="75%">
          ...
          <Col xs={12} sm={12} md={6}>
            <Link to="/cloud-native-management/meshery">
              <StaticImage
                ...
                alt="Meshery - the cloud native management plane"
                src={MeshMap}
              />
            </Link>
          </Col>
            ...
            <div className="side">
              ...
              <div className="description">
                <p>
                  ...
                  <Link to="/cloud-native-management/meshery/integrations">integrations</Link> for
                  Prometheus, Grafana, Jaeger, CloudEvents, and support for WebAssembly filters for
                  Envoy.
                </p>
                <p>
                  Meshery is your microservices manager. With extension points throughout, Meshery
                  offers users and integrators the ability to extend and customize platform
                  functionality.
                </p>
              </div>
