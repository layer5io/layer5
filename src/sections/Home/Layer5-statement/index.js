...
// import VintageBox from "../../../resecore/VintageBox";
      ...
      <div className="section">
        <Row className="row">
              ...
              <div className="left-child">
                ...
                >
                  ...
                  <h2 className="statement">
                    <span>
                      harnessing the unique position service meshes have in
                      changing how developers write applications and how
                      operators run modern infrastructure.
                    </span>
                  </h2>
                  ...
                  <h3 className="statement">
                    ...
                    Layer5 is an empowerer of the developer, the operator, and
                    the service owner
                  </h3>
          ...
          <Col sm={12} md={6} lg={6} className="right-col">
            <StaticImage
              src="./images/Lee-Calcote-Cloud-Native-Rejekts.jpg"
              alt="hero image"
              placeholder="blurred"
              className="hero"
              objectFit="cover"
