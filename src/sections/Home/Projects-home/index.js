              ...
              <Link className="project-card" to="/cloud-native-management/meshmap">
                <div className="project__block__inner">
                  <StaticImage
                    ...
                    width={50}
                    height={80}
                    imgStyle={{ width: "24px", height: "39px" }}
                  />
                  <p>MeshMap</p>
                ...
                <div className="project__block__inner">
                  <ThemeManagerProvider>
                    {isDark ? (
                      <StaticImage
                        loading="lazy"
                        src={projectImage2_light}
                        alt="Light Mode SMP Logo"
                        width={294}
                        height={120}
                        imgStyle={{ width: "98px", height: "40px" }}
                      />
                    ) : (
                      <StaticImage
                        loading="lazy"
                        src={projectImage2_dark}
                        alt="Dark Mode SMP Logo"
                        width={294}
                        height={120}
                        imgStyle={{ width: "98px", height: "40px" }}
                      />
              ...
              <Link className="project-card" to="/cloud-native-management/catalog">
                <div className="project__block__inner">
                  ...
                  <CatalogLogo
                    height="40px"
                    width="auto"
                    style={{ margin: "10px auto", minHeight: "40px" }}
                  />
                  <p>Meshery Catalog</p>
