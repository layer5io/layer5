        ...
        <React.Fragment>
          <ul className="dropdown" style={{ zIndex: "101" }}>
            <div className="nav-grid">
              <div className="hr">
                <Link className="section" to={activeState.path} activeClassName="nav-link-active">
                  {activeState.name}
                </Link>
              ...
              {blogData[activeState.name].nodes.length !== 0 ? (
                <div className="nav-display">
                  <Card
                    frontmatter={blogData[activeState.name].nodes[0].frontmatter}
                    fields={blogData[activeState.name].nodes[0].fields}
                  />
                  <Card
                    frontmatter={blogData[activeState.name].nodes[1].frontmatter}
                    ...
                    <div className="single-card">
                      <div className="transition-container" ref={transitionRef}>
                        ...
                        {isDark ? (
                          <KubernetesImage
                            className={
                              imageInView ? "kubernetes-transition kubernetes" : "kubernetes"
                            }
                            alt="KubernetesImage"
                          />
                        ) : (
                        ...
                        <PrometheusImage
                          className={
                            imageInView ? "prometheus-transition prometheus" : "prometheus"
                          }
                          alt="PrometheusImage"
                        />
                        <img
