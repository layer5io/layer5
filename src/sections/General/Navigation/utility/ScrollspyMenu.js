...
const ScrollspyMenu = ({ menuItems, theme, ...props }) => {
  ...
  return (
    <ul
      ...
      onMouseEnter={wrapDisplay}
      onMouseLeave={wrapNone}
    >
      {menuItems.map((menu, index) => (
        <li
          key={index}
          className={menu.subItems ? "nav-item has-dropdown" : "nav-item"}
                          ...
                          {hover
                            ...
                            : (
                              <Link
                                ...
                                className={subItem.sepLine && "sub-item"}
                                activeClassName="nav-link-active"
                                style={(activeState.name === "Projects" &&
                                    !subItem.sepLine)
                                  ? { display: "none" }
                                  : { display: "block" }}
                              >
              ...
              {blogData[activeState.name].nodes.length !== 0
                ? (
                  <div className="nav-display">
                    <Card
                      frontmatter={blogData[activeState.name].nodes[0]
                        .frontmatter}
                      fields={blogData[activeState.name].nodes[0].fields}
                    />
                    <Card
                      frontmatter={blogData[activeState.name].nodes[1]
                        .frontmatter}
                      fields={blogData[activeState.name].nodes[1].fields}
                    />
                  </div>
                )
                : (
                      ...
                      <div className="single-card">
                        ...
                        >
                          ...
                          <img
                            ...
                            src={theme == "dark"
                              ? ServiceIntefaceImageDark
                              : ServiceIntefaceImage}
                            alt=""
                          />
                          <img
                            className={imageInView
                              ? "ingress-gateway-transition ingress-gateway"
                              : "ingress-gateway"}
                            src={theme == "dark"
                              ? IngressGatewayImageDark
                              : IngressGatewayImage}
                            alt=""
                          />
                          <img
                            className={imageInView
                              ? "kubernetes-transition kubernetes"
                              : "kubernetes"}
                            src={theme == "dark"
                              ? KubernetesImageDark
                              : KubernetesImage}
                          ...
                          <img
                            className={imageInView
                              ? "pod-transition pod"
                              : "pod"}
                            src={theme == "dark" ? PodImageDark : PodImage}
                            alt=""
                          />
                          <img
                            className={imageInView
                              ? "prometheus-transition prometheus"
                              : "prometheus"}
                            src={theme == "dark"
                              ? PrometheusImageDark
                              : PrometheusImage}
                          ...
                          <img
                            className={imageInView
                              ? "supporting-arrows-transition supporting-arrows"
                              : "supporting-arrows"}
