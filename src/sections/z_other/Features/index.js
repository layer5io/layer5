    ...
    <FeaturesSectionWrapper id="features">
      <Container fullWidthSM>
        <SectionTitle UniWidth="65%" className="section-title">
          ...
          <h2>
            Manage your cloud native infra and apps with features
            <span> you won't find anywhere else</span>.
          </h2>
        </SectionTitle>
        <Row>
          <Col xs={12} sm={6} md={4}>
          ...
          <Col xs={12} sm={6} md={4}>
            <div className="features-block v2">
              ...
              <p>
                Harness the power of WebAssembly filters to implement application and offload your
                service development teams from lengthy engineering cycles. Expect and receive more
          ...
          <Col xs={12} sm={6} md={4}>
            <div className="features-block v1">
              ...
              <p>
                Use{" "}
                <Link to="/meshmap" alt="Cloud Native Visual Map">
                  MeshMap
                </Link>{" "}
                to quickly understand how your service mesh is functioning and to intuitively
                reconfigure and tune your mesh in accordance with the needs of your workloads.
              </p>
            </div>
          </Col>
          <Col xs={12} sm={6} md={4}>
            <div className="features-block v2">
              ...
              <p>
                <a
                  href="/meshery/service-mesh-operator"
                  alt="Cloud Native and Service Mesh Operator"
                >
                  Meshery Operator
                </a>
              </p>
