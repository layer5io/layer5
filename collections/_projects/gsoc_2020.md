...
<h3 class="black-text"> Google Summer of Code 2020 and Layer5 Community</h3>
    ...
    <h5 class="black-text"> Project Ideas </h5>
     ...
     <ul>
       ...
       <ol>Linkerd is an ultralight service mesh for Kubernetes and beyond: <a href="https://networkservicemesh.io">https://networkservicemesh.io</a>.</ol>
      </ul>
     <div style="margin-left:25px">
        <li> Benchmarks for Network Service Mesh and Istio</li>
