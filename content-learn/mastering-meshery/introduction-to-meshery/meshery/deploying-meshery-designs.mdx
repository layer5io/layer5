...
{/* <h1 class="chapter-sub-heading">Deploying Meshery Designs</h1> */}
...
1. Ensure you have one or more Meshery designs available. _See Chapter 2: Creating a Meshery Design._
1. Access to a Meshery Server with a connected Kubernetes cluster.
...
<CustomImage
  src={"../../../../src/assets/images/learn-layer5/meshery-deploy/action.png"}
  align="center"
  width="100%"
  style={{
    borderRadius: "15px",
...
1. Click on the **Validate** Icon.
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/performing-validation.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
   ...
   <CustomImage
     src="../../../../src/assets/images/learn-layer5/meshery-deploy/successful-validation.png"
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
1. **Missing Required Field**: This happens when a required field is not provided. For example, in the image below, the first error indicates that the field ".spec.template.spec.containers.0.env.0" must have a value.
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/validation-error.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
1. Re-run the dry run to ensure all issues have been resolved.
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/successful-dry-run.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
1. **Invalid Field Value**: The error message indicates that a field has an invalid value. For instance, in the image below, the fields "spec > ports[0] > port" and "spec > ports[0] > targetPort" have invalid values of 0. These values must be between 1 and 65535, inclusive.
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/dr-invalid-field1.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
   ...
   />
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/dr-invalid-field2.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
1. **Missing Required Field**
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/missing-field.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
1. **Missing Dependencies**: In this case, the error occurs because a Kubernetes Custom Resource Definition(CRD) should have been deployed first before attempting to deploy this component.
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/missing-resource.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
[Meshery Environments](https://docs.meshery.io/concepts/logical/environments) are logical groups of [Connections](https://docs.meshery.io/concepts/logical/connections) which include GitHub integrations, Prometheus connections, and Kubernetes Clusters,etc, managed by Meshery. To make your Kubernetes connections available for selection, you need to assign them to an environment and link that environment to your current [workspace](https://docs.meshery.io/concepts/logical/workspaces). _Note: Environments can be assigned to one or more Workspaces._
...
You can add an environment through the modal when deploying by following these steps:

1. Click on **Add Environments**

   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/add-env.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
1. Select **Create** and put in the name of the environment _Development_ and **Save**.

   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/create-env.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
1. After creating the environment you add connections to the environment, here we want to add a Kubernetes cluster. Click on the **arrows** icon to open the Development Resources modal.
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/assign-conn.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
   ...
   **Available Connections** on the left side shows a list of Kubernetes clusters that are currently managed by Meshery.
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/kube-conn.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
<CustomImage
  src={"../../../../src/assets/images/learn-layer5/meshery-deploy/missing-con.png"}
  align="center"
  width="100%"
  style={{
    borderRadius: "15px",
...
1. Identify the desired connection. Under the **Environment** section, click the dropdown menu to add and select the environment you want to associate with your connection.
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/env-conn.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
<CustomImage
  src={"../../../../src/assets/images/learn-layer5/meshery-deploy/conn-list.png"}
  align="center"
  width="100%"
  style={{
    borderRadius: "15px",
...
<CustomImage
  src={"../../../../src/assets/images/learn-layer5/meshery-deploy/env-error.png"}
  align="center"
  width="100%"
  style={{
    borderRadius: "15px",
...
1. Click **Finish**
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/success-deploy.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
1. **Missing Namespace**: This error occurs when you attempt to create a Kubernetes resource without specifying a namespace. Kubernetes requires that all resources have an associated namespace.
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/missing-ns.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
1. **Empty Label Selector**: This error indicates an empty label selector.
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/empty-ls.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
...
For the comprehensive list of error codes refer to [Error Code Reference]
(https://docs.meshery.io/reference/error-codes) in the Meshery documentation.

If you encounter persistent issues consider consulting the [Meshery Community forum](https://discuss.layer5.io/c/meshery/5)

<CustomImage
  src={"../../../../src/assets/images/learn-layer5/meshery-deploy/error-code.png"}
  align="center"
  width="100%"
  style={{
    borderRadius: "15px",
...
<CustomImage
  src={"../../../../src/assets/images/learn-layer5/meshery-deploy/notification.png"}
  align="center"
  width="100%"
  style={{
    borderRadius: "15px",
...
<CustomImage
  src={"../../../../src/assets/images/learn-layer5/meshery-deploy/notification-center.png"}
  align="center"
  width="100%"
  style={{
    borderRadius: "15px",
...
1. Click on the **Undeploy** icon.
   ...
   <CustomImage
     src={"../../../../src/assets/images/learn-layer5/meshery-deploy/undeploy.png"}
     align="center"
     width="100%"
     style={{
       borderRadius: "15px",
