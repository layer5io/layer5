...
<h1 className="chapter-sub-heading">Lifecycle of Design Reviews</h1>

<h2 className="chapter-sub-heading">Submitting Designs</h2>
...
<h2 className="chapter-sub-heading">Reviewing Designs</h2>

Team members can review designs using comments or annotations.

<h4 className="chapter-sub-heading">Design Reviews with Comments</h4>
...
<h4 className="chapter-sub-heading"><u>Tips for using Comments as a Design Review Tool</u></h4>
...
<h2 className="chapter-sub-heading">Resolving Comments</h2>
...
<h2 className="chapter-sub-heading">Reopening Comments</h2>
...
<h2 className="chapter-sub-heading">Pinning and Locking Comments in Kanvas</h2>

1. <h4 className="chapter-sub-heading">Pinning of Comments</h4>
...
2. <h4 className="chapter-sub-heading">Locking Comments</h4>
...
<h2 className="chapter-sub-heading">Design Reviews with Annotations</h2>
