...
<a href={commentingViaDock}>
  <img src={commentingViaDock} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>
...
<a href={commentingViaMenu}>
  <img src={commentingViaMenu} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>

<h4 class="chapter-sub-heading"><u>Tips for using Comments as a Design Review Tool</u></h4>

<a href={commentsAsDesignTool}>
  <img src={commentsAsDesignTool} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>
...
<a href={comments}>
  <img src={comments} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>
...
<a href={commentHistory}>
  <img src={commentHistory} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>
...
<a href={reopeningComments}>
  <img src={reopeningComments} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>
...
<a href={pinningComments}>
  <img src={pinningComments} style="max-width: 500px; height: auto; width: 100%;" align="center" style="max-height:40rem;object-fit:contain;" />
</a>
...
<a href={lockingComments}>
  <img src={lockingComments} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>
...
<a href={annotations}>
  <img src={annotations} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>
...
<a href={whiteboarding}>
  <img src={whiteboarding} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>
...
<a href={whiteboardAccess}>
  <img src={whiteboardAccess} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>
...
<a href={shapeAnnotation}>
  <img src={shapeAnnotation} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>
...
<a href={textAnnotation}>
  <img src={textAnnotation} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>
...
<a href={tooltipAnnotation}>
  <img src={tooltipAnnotation} style="max-width: 500px; height: auto; width: 100%;" align="center" />
</a>
