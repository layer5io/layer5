...
<h2 className="chapter-sub-heading">Creating Teams</h2>
...
<h2 className="chapter-sub-heading">Creating Workspaces</h2>
...
<h2 className="chapter-sub-heading">Creating Environments and Associating Connections</h2>
...
<h3 className="chapter-sub-heading">Creating an Environment</h3>
...
<h3 className="chapter-sub-heading">Associating Connections with an Environment</h3>
...
<h3 className="chapter-sub-heading">Navigating the Connections Page</h3>
...
<h4 className="chapter-sub-heading">Adding Cluster Connection</h4>
...
<h4 className="chapter-sub-heading">Viewing Cluster Connection Details</h4>
...
<h2 className="chapter-sub-heading">Integrating Workspaces with Environments and Designs</h2>
...
<h3 className="chapter-sub-heading">Assigning Environments and Designs to Workspaces</h3>
...
<h4 className="chapter-sub-heading">Confirm Workspace Association</h4>
