...
<h2 className="chapter-sub-heading">Meshery Designs and Models</h2>
...
<h2 className="chapter-sub-heading">Understanding Meshery Components</h2>
...
<h2 className="chapter-sub-heading">Meshery Design at a Glance</h2>
...
<h2 className="chapter-sub-heading">Meshery Component Representation</h2>
...
<h2 className="chapter-sub-heading">Kubernetes Components</h2>
...
<h3 className="chapter-sub-heading">Basic Concepts of Kubernetes Components in Meshery</h3>
...
<h2 className="chapter-sub-heading">Arrows in Meshery Designs</h2>
...
<h2 className="chapter-sub-heading">Examples of Edge Relationships</h2>
...
<h2 className="chapter-sub-heading">Meshery Integration Components</h2>
...
<img
  ...
  width="50%"
/>
<h5 className="chapter-sub-heading">_Example of integration components in Meshery_</h5>
...
<h2 className="chapter-sub-heading">Methods to Identify Components on the Playground Design Canvas</h2>
...
<h2 className="chapter-sub-heading">Annotations</h2>
...
<h2 className="chapter-sub-heading">Annotation Examples</h2>
...
<h2 className="chapter-sub-heading">Customizing Components and Annotation</h2>
