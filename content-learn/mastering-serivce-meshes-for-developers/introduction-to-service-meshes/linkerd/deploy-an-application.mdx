...
As part of Linkerd deployment in [Previous chapter](/learn/learning-paths/mastering-meshery-istio/introduction-to-service-meshes/linkerd/getting-started), you have deployed the sidecar injector.
