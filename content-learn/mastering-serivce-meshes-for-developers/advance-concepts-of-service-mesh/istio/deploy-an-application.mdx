...
As part of Istio deployment in [Previous chapter](/learn-ng/mastering-meshery-istio/advance-concepts-of-service-mesh/istio/getting-started), you have deployed the sidecar injector.
...
Applying this yaml file included in the Istio package you collected in [Getting Started](/learn-ng/mastering-meshery-istio/introduction-to-service-meshes/istio/getting-started#1) will deploy the BookInfo app in you cluster.
