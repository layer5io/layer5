...
<h4 class="chapter-alt-heading"> Route 50% of traffic to version V3 of reviews service</h4>

```sh
kubectl apply -f  samples/bookinfo/networking/virtual-service-reviews-50-v3.yaml
```

<h4 class="chapter-alt-heading"> Route 100% of traffic to version V3 of reviews service</h4>
