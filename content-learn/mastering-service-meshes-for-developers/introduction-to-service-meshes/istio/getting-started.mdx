...
2. Click the (+) icon on the `Install` card and click on `Istio Service Mesh` to install latest version of Istio.
   ...
   <a href="../../../../src/assets/images/learn-layer5/istio/install-istio1.webp">
     <img src="../../../../src/assets/images/learn-layer5/istio/install-istio1.webp" width="70%" align="center" />
   </a>

 3. Click the `Deploy` button on the confirmation modal.
  
    <a href="../../../../src/assets/images/learn-layer5/istio/install-istio2.webp">
       <img src="../../../../src/assets/images/learn-layer5/istio/install-istio2.webp"  width="70%" align="center" />
   </a>
