...
<h2 class="chapter-sub-heading">Start managing traffic routes</h2>

Some basics to get us started.

<h3 class="chapter-sub-heading">Send all requests to Productpage v1</h3>
...
<h3 class="chapter-sub-heading">Send all requests to Productpage v2</h3>
...
<h2 class="chapter-sub-heading">Traffic routing based on user or user-agent type</h2>

<br />

<h3 class="chapter-sub-heading">Redirect requests from mobile devices</h3>
...
<h3 class="chapter-sub-heading">Redirect requests based on HTTP header information</h3>
...
<h2 class="chapter-sub-heading">Traffic Mirroring with Istio</h2>
...
<h2 class="chapter-sub-heading">Injecting Latency</h2>

Acknowledging the fallacy that the network is always reliable, you will intentionally cause a little chaos.

<h3 class="chapter-sub-heading">Exploring timeouts with Reviews service</h3>
...
<h3 class="chapter-sub-heading">Exploring timeouts with Ratings service</h3>
...
<h2 class="chapter-sub-heading">Retries</h2>

Overcoming the latency issue.

<h3 class="chapter-sub-heading">Set 5 retry attempts and a 3 second timeout</h3>
...
<h4 class="chapter-alt-heading"> Route all traffic to version V1</h4>

```sh
kubectl apply -f route-v1-v2/v1.yaml
```

<h4 class="chapter-alt-heading"> Route all traffic to version V2</h4>

```sh
kubectl apply -f route-v1-v2/v2.yaml
```

<h3 class="chapter-sub-heading">Traffic routing based on user or user-agent type</h3>
