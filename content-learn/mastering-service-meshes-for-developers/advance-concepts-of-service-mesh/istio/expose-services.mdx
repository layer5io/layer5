...
<h3 class="chapter-sub-heading">Find the external port of the Istio Ingress Gateway by running:</h3>
...
<h4 class="chapter-alt-heading">Configure the Bookinfo route with the Istio Ingress gateway</h4>
