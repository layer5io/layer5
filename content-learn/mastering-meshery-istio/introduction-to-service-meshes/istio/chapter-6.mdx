...
<h3 class="chapter-sub-heading"> 6.3 Verify fault injection</h3>
...
<h3 class="chapter-sub-heading"> Inject 7s delay for ratings service</h3>

```sh
kubectl apply -f samples/bookinfo/networking/virtual-service-ratings-test-delay.yaml
```

<h3 class="chapter-sub-heading"> Inject HTTP abort for ratings service</h3>
