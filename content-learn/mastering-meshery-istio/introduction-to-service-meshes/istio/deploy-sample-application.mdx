...
If your environment **does NOT** supports either of these two APIs, then you may use [manual sidecar injection](https://github.com/layer5io/istio-service-mesh-workshop/blob/master/lab-2/appendix-manual-injection.md) to deploy the sample app.

As part of Istio deployment in [Previous chapter](/learn-ng/mastering-meshery-istio/performance-of-service-mesh/istio/getting-started), you have deployed the sidecar injector.
...
Applying this yaml file included in the Istio package you collected in [Getting Started](/learn-ng/mastering-meshery-istio/performance-of-service-mesh/istio/getting-started#1) will deploy the BookInfo app in you cluster.
