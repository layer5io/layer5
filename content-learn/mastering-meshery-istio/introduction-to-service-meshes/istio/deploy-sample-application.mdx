...
Applying this yaml file included in the Istio package you collected in [Chapter-1](/learn-ng/mastering-meshery-istio/performance-of-service-mesh/istio/getting-started#1) will deploy the BookInfo app in you cluster.
