...
As part of Istio deployment in [Previous chapter](/learn-ng/mastering-meshery-istio/introduction-to-service-meshes/istio/getting-started), you have deployed the sidecar injector.
