...
<h2 class="chapter-sub-heading"> 7.1 Preparing for circuit breaking</h2>
<br />
...
<h2 class="chapter-sub-heading"> 7.2 Configure circuit breaking</h2>
...
<h2 class="chapter-sub-heading">7.3 Time to trip the circuit</h2>
...
<h3 class="chapter-sub-heading"> Configure circuit breaking</h3>
