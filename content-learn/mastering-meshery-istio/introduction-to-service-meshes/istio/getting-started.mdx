...
<h3 class="chapter-sub-heading"><a name="1">Install Istio</a></h3>

Using Meshery, select `Istio` from the `Management` menu.

<a href={IstioAdapter}>
<img src={IstioAdapter} align="center" />
</a>
...
1. Click the (+) icon on the `Install` card and select `Latest Istio` to install the latest version of Istio.
   ...
   <a href={InstallIstio}>
   <img src={InstallIstio} align="center" />
   </a>
...
<h4 class="chapter-alt-heading"><a name="1.1">Download Istio</a></h4>
...
<h4 class="chapter-alt-heading"><a name="1.2">Setting up istioctl</a></h4>
...
<h4 class="chapter-alt-heading"><a name="1.3">Install Istio</a></h4>
...
<h3 class="chapter-sub-heading"><a name="2">Verify install</a></h3>
