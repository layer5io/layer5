...
<h2 class="chapter-sub-heading"> 3.1 Inspecting the Istio Ingress Gateway</h2>
...
<h2 class="chapter-sub-heading">3.2 View Istio Ingress Gateway for Bookinfo</h2>
<br />
...
<h3 class="chapter-sub-heading"> 3.2.2 - Create a DNS entry:</h3>
...
<h2 class="chapter-sub-heading"> 3.3 Apply default destination rules</h2>
