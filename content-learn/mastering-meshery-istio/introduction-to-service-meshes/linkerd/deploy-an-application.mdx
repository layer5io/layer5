...
As part of Linkerd deployment in [Previous chapter](/learn-ng/mastering-meshery-istio/introduction-to-service-meshes/linkerd/getting-started), you have deployed the sidecar injector.
...
As part of Linkerd deployment in [Lab 1](/learn-ng/mastering-meshery-istio/introduction-to-service-meshes/linkerd/getting-started), you have deployed the sidecar proxy injector, which should be running in your control plane. To verify, execute this command:
...
<h4 class="chapter-alt-heading">Inject Linkerd proxy into the sample application</h4>
