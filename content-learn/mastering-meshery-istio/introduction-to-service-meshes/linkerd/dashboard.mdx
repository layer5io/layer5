...
1. stat : This will show the “golden” metrics for each deployment:
    1. Success rates
    1. Request rates
    1. Latency distribution percentiles

1. top : to get a real-time view of which paths are being called.

  <a href={Top}>
    <img src={Top} width="100%" align="center" />
  </a>

1. tap : shows the stream of requests across a single pod, deployment, or even everything in the emojivoto namespace.
