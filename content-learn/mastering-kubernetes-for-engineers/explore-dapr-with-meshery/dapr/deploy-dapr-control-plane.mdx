...
1. In the modal that appears:
   ...
   - Then, click **Import**.
    ...
    <CustomImage
      src={"/assets/images/learning-path/dapr/dapr-helm.png"}
      align="center"
      width="100%"
    />
...
<MesheryDesignEmbed
  ...
  embedScriptSrc="/assets/images/learning-path/embed-test/embedded-design-dapr.js"
/>
...
<MesheryDesignEmbed
  ...
  embedScriptSrc="/assets/images/learning-path/embed-test/embedded-design-dapr-deployments.js"
/>
...
<CustomImage
  src={"/assets/images/learning-path/dapr/relationship.png"}
  align="center"
  width="100%"
/>
...
<MesheryDesignEmbed
  ...
  embedScriptSrc="/assets/images/learning-path/embed-test/embedded-design-dapr-roles.js"
/>
...
<MesheryDesignEmbed
  ...
  embedScriptSrc="/assets/images/learning-path/embed-test/embedded-design-dapr-crds.js"
/>
...
<CustomImage
  src={"/assets/images/learning-path/dapr/grouped.png"}
  align="center"
  width="100%"
/>
...
<CustomImage
  src={"/assets/images/learning-path/dapr/dapr-visualizer.png"}
  align="center"
  width="100%"
/>
