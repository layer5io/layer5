...
exports.createPages = async ({ actions, graphql, reporter }) => {
  ...
  createRedirect({ fromPath: "/smi", toPath: "/products/service-mesh-interface-conformance", redirectInBrowser: true, isPermanent: true });
  createRedirect({ fromPath: "/products/getnighthawk", toPath: "/products/nighthawk", redirectInBrowser: true, isPermanent: true });
  createRedirect({ fromPath: "/products/getnighthawk", toPath: "/products/nighthawk", redirectInBrowser: true, isPermanent: true });
